...
static inline __attribute__((always_inline)) int main__temp1246v() {
  ...
  li__buffer__unsafe_ptr=__temp1251v__buffer__unsafe_ptr;
  li__buffer__unsafe_size=__temp1251v__buffer__unsafe_size;
  li__buffer__unsafe_offset=__temp1251v__buffer__unsafe_offset;
  li__buffer__unsafe_align=__temp1251v__buffer__unsafe_align;
  li__length=__temp1251v__length;
  __temp_errcode=push__temp579v(&li__buffer__unsafe_ptr,&li__buffer__unsafe_size,&li__buffer__unsafe_offset,&li__buffer__unsafe_align,&li__length,&__temp1253v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
  __temp1254v=0.1;
  ...
  __temp_errcode=push__temp579v(&li__buffer__unsafe_ptr,&li__buffer__unsafe_size,&li__buffer__unsafe_offset,&li__buffer__unsafe_align,&li__length,&__temp1255v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
  __temp1256v=0.1;
  ...
  __temp_errcode=push__temp579v(&li__buffer__unsafe_ptr,&li__buffer__unsafe_size,&li__buffer__unsafe_offset,&li__buffer__unsafe_align,&li__length,&__temp1257v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
  __temp1258v=0.1;
  ...
  __temp1259v=1;
  __temp_errcode=mutget__temp576v(&li__buffer__unsafe_ptr,&li__buffer__unsafe_size,&li__buffer__unsafe_offset,&li__buffer__unsafe_align,&li__length,__temp1259v,&__temp1260v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
  __temp1261v=0.2;
  ...
  __temp1262v=0;
  __temp_errcode=get__temp573v(&li__buffer__unsafe_ptr,&li__buffer__unsafe_size,&li__buffer__unsafe_offset,&li__buffer__unsafe_align,&li__length,__temp1262v,&__temp1263v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
  if(!__temp1263v__){
  ...
  __temp1266v=1;
  __temp_errcode=get__temp573v(&li__buffer__unsafe_ptr,&li__buffer__unsafe_size,&li__buffer__unsafe_offset,&li__buffer__unsafe_align,&li__length,__temp1266v,&__temp1267v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
  if(!__temp1267v__){
