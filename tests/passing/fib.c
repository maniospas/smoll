...
int fib__temp1248v(uint64_t n, uint64_t* __temp1274v) ;
...
static inline __attribute__((always_inline)) void add__temp170v(uint64_t x, uint64_t y, uint64_t* __temp1273v) {
  int __temp171v__=0;
  uint64_t z=0;
...
int fib__temp1248v(uint64_t n, uint64_t* __temp1274v) {
  ...
  __temp_errcode=fib__temp1248v(__temp1261v__,&__temp1262v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
  __temp1263v=2;
  ...
  __temp_errcode=fib__temp1248v(__temp1264v__,&__temp1265v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
...
static inline __attribute__((always_inline)) int main__temp1252v() {
  ...
  int __temp_complain=0;
  __temp1253v=10;
  __temp_errcode=fib__temp1248v(__temp1253v,&__temp1254v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
