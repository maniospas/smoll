...
static inline __attribute__((always_inline)) int dir__temp1311v(const char* _path, void** __temp1359v) {
...
static inline __attribute__((always_inline)) int print__temp585v(void* s__buf__unsafe_ptr, unsigned long long s__buf__unsafe_size, unsigned long long s__buf__unsafe_align, unsigned long long s__dat__pos, unsigned long long s__dat__length, char s__dat__first) {
  const char* endl=0;
  unsigned long long __temp587v__=0;
  int __temp588v__=0;
  int __temp_errcode=0;
  endl=__temp343v;
  add__temp109v(s__dat__length,s__dat__pos,&__temp587v__);
  gt__temp205v(__temp587v__,s__buf__unsafe_size,&__temp588v__);
  if(__temp588v__){
  __temp_errcode=10;
  goto __temp_failure;
  }
...
static inline __attribute__((always_inline)) int main__temp1346v() {
  ...
  int __temp1445v=0;
  int __temp_errcode=0;
  __temp_errcode=dir__temp1311v(__temp1347v,&__temp1348v__unsafe_ptr);
  if(__temp_errcode){
  goto __temp_failure;
  }
  ...
  __temp_errcode=print__temp585v(entry__buf__unsafe_ptr,entry__buf__unsafe_size,entry__buf__unsafe_align,entry__dat__pos,entry__dat__length,entry__dat__first);
  if(__temp_errcode){
  goto __temp_failure;
  }
  }
