...
```rust
alloc(nat ) -> (edit char[] {element size 1} {follows char ptr ..unsafe_ptr})
```
Potential errors:
...
```rust
char_arena(edit char[] {element size 1}) -> (edit char[] {element size 1} {follows char ptr buf.unsafe_ptr}, mut nat pos)
```
