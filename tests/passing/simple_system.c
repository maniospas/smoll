...
static inline __attribute__((always_inline)) void char____t_buffer____buffer__t558t(char** __t1846t, uint64_t* __t1847t, uint16_t* __t1848t, uint16_t* __t1849t) {
  char* unsafe_ptr=0;
  ...
  unsafe_align=1;
  *__t1846t=unsafe_ptr;
  *__t1847t=unsafe_size;
  *__t1848t=unsafe_offset;
  *__t1849t=unsafe_align;
}

static inline __attribute__((always_inline)) void attach_type__t21t(char* to, const char* from, char** __t1850t) {
  *__t1850t=to;
}

static inline __attribute__((always_inline)) void false__t10t(int* __t1851t) {
  int value=0;
  *__t1851t=value;
}

static inline __attribute__((always_inline)) void not__t35t(int __t_anon0, int* __t1852t) {
  int __t36t__=0;
...
static inline __attribute__((always_inline)) void is_different__t93t(uint64_t x, uint64_t y, int* __t1853t) {
  int __t94t=0;
  int __t95t__=0;
...
static inline __attribute__((always_inline)) void add__t170t(uint64_t x, uint64_t y, uint64_t* __t1854t) {
  int __t171t__=0;
  uint64_t z=0;
...
static inline __attribute__((always_inline)) void neq__t142t(uint64_t x, uint64_t y, char* __t1855t) {
  int __t143t__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void ge__t319t(uint64_t x, uint64_t y, char* __t1856t) {
  int __t320t__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void nat__t505t(uint16_t x, uint64_t* __t1857t) {
  uint64_t value=0;
  value=x;
  goto __t_return;
  __t_return:
...
static inline __attribute__((always_inline)) void mul__t194t(uint64_t x, uint64_t y, uint64_t* __t1858t) {
  int __t195t__=0;
  uint64_t z=0;
...
static inline __attribute__((always_inline)) void attach_type__t20t(char* to, char* from, char** __t1859t) {
  *__t1859t=to;
}

static inline __attribute__((always_inline)) void add__t503t(char* allocated, uint64_t offset, char** __t1860t) {
  char* element=0;
  char* __t504t__=0;
...
static inline __attribute__((always_inline)) int get__t597t(char* buffer__unsafe_ptr, uint64_t buffer__unsafe_size, uint16_t buffer__unsafe_offset, uint16_t buffer__unsafe_align, uint64_t i, char** __t1861t) {
  char __t598t__=0;
...
static inline __attribute__((always_inline)) void str__t632t(char* unsafe_ptr, uint64_t dat__pos, uint64_t dat__length, char dat__first, char** __t1862t, uint64_t* __t1863t, uint64_t* __t1864t, char* __t1865t) {
  goto __t_return;
  __t_return:
  *__t1862t=unsafe_ptr;
  *__t1863t=dat__pos;
  *__t1864t=dat__length;
  *__t1865t=dat__first;
}

static inline __attribute__((always_inline)) int str__t636t(char* buf__unsafe_ptr, uint64_t buf__unsafe_size, uint16_t buf__unsafe_offset, uint16_t buf__unsafe_align, uint64_t dat__pos, uint64_t dat__length, char dat__first, char** __t1866t, uint64_t* __t1867t, uint64_t* __t1868t, char* __t1869t) {
  char* unsafe_ptr=0;
  ...
  __t_failure:__t_return:
  *__t1866t=__t643t__unsafe_ptr;
  *__t1867t=__t643t__dat__pos;
  *__t1868t=__t643t__dat__length;
  *__t1869t=__t643t__dat__first;
  
  return __t_errcode;
}

static inline __attribute__((always_inline)) int str__t668t(char* buf__unsafe_ptr, uint64_t buf__unsafe_size, uint16_t buf__unsafe_offset, uint16_t buf__unsafe_align, uint64_t pos, uint64_t length, char** __t1870t, uint64_t* __t1871t, uint64_t* __t1872t, char* __t1873t) {
  uint64_t __t669t=0;
  char __t670t__=0;
  char* __t671t__=0;
  ...
  __t_failure:__t_return:
  *__t1870t=__t673t__unsafe_ptr;
  *__t1871t=__t673t__dat__pos;
  *__t1872t=__t673t__dat__length;
  *__t1873t=__t673t__dat__first;
  
  return __t_errcode;
}

int str__t674t(const char* c, char** __t1874t, uint64_t* __t1875t, uint64_t* __t1876t, char* __t1877t) {
  ...
  __t_failure:__t_return:
  *__t1874t=__t681t__unsafe_ptr;
  *__t1875t=__t681t__dat__pos;
  *__t1876t=__t681t__dat__length;
  *__t1877t=__t681t__dat__first;
  
  return __t_errcode;
}

static inline __attribute__((always_inline)) void len__t682t(char* s__unsafe_ptr, uint64_t s__dat__pos, uint64_t s__dat__length, char s__dat__first, uint64_t* __t1878t) {
  goto __t_return;
  __t_return:
  *__t1878t=s__dat__length;
}

static inline __attribute__((always_inline)) void free__t501t(char** __t1879t) {
  char* allocated=*__t1879t;
  if(allocated){
  free(allocated);
  }
  *__t1879t=allocated;
...
static inline __attribute__((always_inline)) void eq__t118t(uint64_t x, uint64_t y, char* __t1880t) {
  int __t119t__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void exists__t435t(char* x, char* __t1881t) {
  char z=0;
  z=x!=0;
  goto __t_return;
  __t_return:
...
static inline __attribute__((always_inline)) void not__t26t(char value, char* __t1882t) {
  char z=0;
  if(!value){
  z=1;
  }
...
static inline __attribute__((always_inline)) int alloc__t494t(uint64_t bytes, char** __t1883t) {
  char* allocated=0;
  char __t495t__=0;
  char __t496t__=0;
  int __t_errcode=0;
...
static inline __attribute__((always_inline)) int alloc__t508t(char** __t1884t, uint64_t* __t1885t, uint16_t* __t1886t, uint16_t* __t1887t, uint64_t size, char** __t1888t, uint64_t* __t1889t, uint16_t* __t1890t, uint16_t* __t1891t) {
  char* buffer__unsafe_ptr=*__t1884t;
  uint64_t buffer__unsafe_size=*__t1885t;
  uint16_t buffer__unsafe_offset=*__t1886t;
  uint16_t buffer__unsafe_align=*__t1887t;
  int __t509t=0;
  uint64_t __t510t=0;
  char __t511t__=0;
  uint64_t __t512t=0;
  ...
  *__t1888t=__t521t__unsafe_ptr;
  *__t1889t=__t521t__unsafe_size;
  *__t1890t=__t521t__unsafe_offset;
  *__t1891t=__t521t__unsafe_align;
  
  return __t_errcode;
}

static inline __attribute__((always_inline)) int copy_null_terminated__t703t(char* other__unsafe_ptr, uint64_t other__dat__pos, uint64_t other__dat__length, char other__dat__first, char** __t1892t, uint64_t* __t1893t, uint64_t* __t1894t, char* __t1895t) {
  ...
  *endpos=0;
  ...
  __t_return:
  *__t1892t=__t711t__unsafe_ptr;
  *__t1893t=__t711t__dat__pos;
  *__t1894t=__t711t__dat__length;
  *__t1895t=__t711t__dat__first;
  
  return __t_errcode;
}

int cstr unsafe_tmp__t712t(char* other__unsafe_ptr, uint64_t other__dat__pos, uint64_t other__dat__length, char other__dat__first, const char** __t1896t, char** __t1897t, uint64_t* __t1898t, uint64_t* __t1899t, char* __t1900t) {
  ...
  __t_return:
  *__t1896t=cstr;
  *__t1897t=str__unsafe_ptr;
  *__t1898t=str__dat__pos;
  *__t1899t=str__dat__length;
  *__t1900t=str__dat__first;
  
  return __t_errcode;
}

static inline __attribute__((always_inline)) int safe__t1371t(const char* cmd, const char** __t1901t) {
  char unsafe_chars=0;
  int __t_errcode=0;
  int __t_complain=0;
  unsafe_chars=0;
...
static inline __attribute__((always_inline)) void system_return__t1370t(const char* cmd, int64_t* __t1902t) {
  int64_t result=0;
  result=system(cmd);
  goto __t_return;
  __t_return:
...
static inline __attribute__((always_inline)) void int__t415t(uint64_t x, int64_t* __t1903t) {
  int __t416t=0;
  int __t417t=0;
  int __t418t=0;
  int64_t z=0;
...
static inline __attribute__((always_inline)) void is_different__t81t(int64_t x, int64_t y, int* __t1904t) {
  int __t82t=0;
  int __t83t__=0;
...
static inline __attribute__((always_inline)) void neq__t131t(int64_t x, int64_t y, char* __t1905t) {
  int __t132t__=0;
  char z=0;
...
int system__t1379t(char* _cmd__unsafe_ptr, uint64_t _cmd__dat__pos, uint64_t _cmd__dat__length, char _cmd__dat__first) {
  ...
  int __t_errcode=0;
  int __t_complain=0;
  __t_errcode=cstr unsafe_tmp__t712t(_cmd__unsafe_ptr,_cmd__dat__pos,_cmd__dat__length,_cmd__dat__first,&__t1380t__cstr,&__t1380t__str__unsafe_ptr,&__t1380t__str__dat__pos,&__t1380t__str__dat__length,&__t1380t__str__dat__first);
  if(__t_errcode){
  goto __t_failure;
  }
...
static inline __attribute__((always_inline)) int main__t1842t() {
  ...
  __t_errcode=system__t1379t(__t1844t__unsafe_ptr,__t1844t__dat__pos,__t1844t__dat__length,__t1844t__dat__first);
  if(__t_errcode){
  goto __t_failure;
  }
