...
static inline __attribute__((always_inline)) void char____t_buffer____buffer__t557t(char** __t2003t, uint64_t* __t2004t, uint16_t* __t2005t, uint16_t* __t2006t) {
  char* unsafe_ptr=0;
  ...
  unsafe_align=1;
  *__t2003t=unsafe_ptr;
  *__t2004t=unsafe_size;
  *__t2005t=unsafe_offset;
  *__t2006t=unsafe_align;
}

static inline __attribute__((always_inline)) void attach_type__t22t(char* to, const char* from, char** __t2007t) {
  *__t2007t=to;
}

static inline __attribute__((always_inline)) void false__t10t(int* __t2008t) {
  int value=0;
  *__t2008t=value;
}

static inline __attribute__((always_inline)) void not__t36t(int __t_anon0, int* __t2009t) {
  int __t37t__=0;
...
static inline __attribute__((always_inline)) void is_different__t94t(uint64_t x, uint64_t y, int* __t2010t) {
  int __t95t=0;
  int __t96t__=0;
...
static inline __attribute__((always_inline)) void add__t174t(uint64_t x, uint64_t y, uint64_t* __t2011t) {
  int __t175t__=0;
  uint64_t z=0;
...
static inline __attribute__((always_inline)) void neq__t143t(uint64_t x, uint64_t y, char* __t2012t) {
  int __t144t__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void ge__t323t(uint64_t x, uint64_t y, char* __t2013t) {
  int __t324t__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void nat__t512t(uint16_t x, uint64_t* __t2014t) {
  uint64_t value=0;
  value=x;
  goto __t_return;
  __t_return:
...
static inline __attribute__((always_inline)) void mul__t198t(uint64_t x, uint64_t y, uint64_t* __t2015t) {
  int __t199t__=0;
  uint64_t z=0;
...
static inline __attribute__((always_inline)) void attach_type__t21t(char* to, char* from, char** __t2016t) {
  *__t2016t=to;
}

static inline __attribute__((always_inline)) void add__t510t(char* allocated, uint64_t offset, char** __t2017t) {
  char* element=0;
  char* __t511t__=0;
...
static inline __attribute__((always_inline)) int get__t597t(char* buffer__unsafe_ptr, uint64_t buffer__unsafe_size, uint16_t buffer__unsafe_offset, uint16_t buffer__unsafe_align, uint64_t i, char** __t2018t) {
  char __t598t__=0;
...
static inline __attribute__((always_inline)) void str__t632t(char* unsafe_ptr, uint64_t dat__pos, uint64_t dat__length, char dat__first, char** __t2019t, uint64_t* __t2020t, uint64_t* __t2021t, char* __t2022t) {
  goto __t_return;
  __t_return:
  *__t2019t=unsafe_ptr;
  *__t2020t=dat__pos;
  *__t2021t=dat__length;
  *__t2022t=dat__first;
}

static inline __attribute__((always_inline)) int str__t636t(char* buf__unsafe_ptr, uint64_t buf__unsafe_size, uint16_t buf__unsafe_offset, uint16_t buf__unsafe_align, uint64_t dat__pos, uint64_t dat__length, char dat__first, char** __t2023t, uint64_t* __t2024t, uint64_t* __t2025t, char* __t2026t) {
  char* unsafe_ptr=0;
  ...
  __t_failure:__t_return:
  *__t2023t=__t643t__unsafe_ptr;
  *__t2024t=__t643t__dat__pos;
  *__t2025t=__t643t__dat__length;
  *__t2026t=__t643t__dat__first;
  
  return __t_errcode;
}

static inline __attribute__((always_inline)) int str__t668t(char* buf__unsafe_ptr, uint64_t buf__unsafe_size, uint16_t buf__unsafe_offset, uint16_t buf__unsafe_align, uint64_t pos, uint64_t length, char** __t2027t, uint64_t* __t2028t, uint64_t* __t2029t, char* __t2030t) {
  uint64_t __t669t=0;
  char __t670t__=0;
  char* __t671t__=0;
  ...
  __t_failure:__t_return:
  *__t2027t=__t673t__unsafe_ptr;
  *__t2028t=__t673t__dat__pos;
  *__t2029t=__t673t__dat__length;
  *__t2030t=__t673t__dat__first;
  
  return __t_errcode;
}

int str__t674t(const char* c, char** __t2031t, uint64_t* __t2032t, uint64_t* __t2033t, char* __t2034t) {
  ...
  __t_failure:__t_return:
  *__t2031t=__t681t__unsafe_ptr;
  *__t2032t=__t681t__dat__pos;
  *__t2033t=__t681t__dat__length;
  *__t2034t=__t681t__dat__first;
  
  return __t_errcode;
}

static inline __attribute__((always_inline)) void len__t682t(char* s__unsafe_ptr, uint64_t s__dat__pos, uint64_t s__dat__length, char s__dat__first, uint64_t* __t2035t) {
  goto __t_return;
  __t_return:
  *__t2035t=s__dat__length;
}

static inline __attribute__((always_inline)) void exists__t442t(char* x, char* __t2036t) {
  char z=0;
  z=x!=0;
  goto __t_return;
  __t_return:
...
static inline __attribute__((always_inline)) void free__t508t(char** __t2037t) {
  char* allocated=*__t2037t;
  if(allocated){
  free(allocated);
  }
  *__t2037t=allocated;
...
static inline __attribute__((always_inline)) void eq__t119t(uint64_t x, uint64_t y, char* __t2038t) {
  int __t120t__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void not__t27t(char value, char* __t2039t) {
  char z=0;
  if(!value){
  z=1;
  }
...
static inline __attribute__((always_inline)) int alloc__t501t(uint64_t bytes, char** __t2040t) {
  char* allocated=0;
  char __t502t__=0;
  char __t503t__=0;
  int __t_errcode=0;
...
static inline __attribute__((always_inline)) int alloc__t515t(char** __t2041t, uint64_t* __t2042t, uint16_t* __t2043t, uint16_t* __t2044t, uint64_t size, char** __t2045t, uint64_t* __t2046t, uint16_t* __t2047t, uint16_t* __t2048t) {
  char* buffer__unsafe_ptr=*__t2041t;
  uint64_t buffer__unsafe_size=*__t2042t;
  uint16_t buffer__unsafe_offset=*__t2043t;
  uint16_t buffer__unsafe_align=*__t2044t;
  int __t516t=0;
  char __t517t__=0;
  char __t519t__=0;
  uint64_t __t520t=0;
  ...
  __t_return:
  *__t2041t=buffer__unsafe_ptr;
  *__t2042t=buffer__unsafe_size;
  *__t2043t=buffer__unsafe_offset;
  *__t2044t=buffer__unsafe_align;
...
static inline __attribute__((always_inline)) int copy_null_terminated__t705t(char* other__unsafe_ptr, uint64_t other__dat__pos, uint64_t other__dat__length, char other__dat__first, char** __t2049t, uint64_t* __t2050t, uint64_t* __t2051t, char* __t2052t) {
  ...
  *endpos=0;
  ...
  __t_return:
  *__t2049t=__t714t__unsafe_ptr;
  *__t2050t=__t714t__dat__pos;
  *__t2051t=__t714t__dat__length;
  *__t2052t=__t714t__dat__first;
  
  return __t_errcode;
}

int unsafe_temp__t715t(char* other__unsafe_ptr, uint64_t other__dat__pos, uint64_t other__dat__length, char other__dat__first, const char** __t2053t, char** __t2054t, uint64_t* __t2055t, uint64_t* __t2056t, char* __t2057t) {
  ...
  __t_return:
  *__t2053t=cstr;
  *__t2054t=str__unsafe_ptr;
  *__t2055t=str__dat__pos;
  *__t2056t=str__dat__length;
  *__t2057t=str__dat__first;
  
  return __t_errcode;
}

static inline __attribute__((always_inline)) void cstr__t722t(const char* value__cstr, char* value__str__unsafe_ptr, uint64_t value__str__dat__pos, uint64_t value__str__dat__length, char value__str__dat__first, const char** __t2058t) {
  goto __t_return;
  __t_return:
  *__t2058t=value__cstr;
}

static inline __attribute__((always_inline)) int safe__t1530t(const char* cmd, const char** __t2059t) {
  char unsafe_chars=0;
  int __t_errcode=0;
  int __t_complain=0;
  unsafe_chars=0;
...
static inline __attribute__((always_inline)) void system_return__t1529t(const char* cmd, int64_t* __t2060t) {
  int64_t result=0;
  result=system(cmd);
  goto __t_return;
  __t_return:
...
static inline __attribute__((always_inline)) void int__t422t(uint64_t x, int64_t* __t2061t) {
  int __t423t=0;
  int __t424t=0;
  int __t425t=0;
  int64_t z=0;
...
static inline __attribute__((always_inline)) void is_different__t82t(int64_t x, int64_t y, int* __t2062t) {
  int __t83t=0;
  int __t84t__=0;
...
static inline __attribute__((always_inline)) void neq__t132t(int64_t x, int64_t y, char* __t2063t) {
  int __t133t__=0;
  char z=0;
...
static inline __attribute__((always_inline)) int main__t1998t() {
  ...
  __t_errcode=system__t1539t(__t2001t__unsafe_ptr,__t2001t__dat__pos,__t2001t__dat__length,__t2001t__dat__first);
  if(__t_errcode){
  goto __t_failure;
  }
