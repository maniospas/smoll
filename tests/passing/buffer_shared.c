...
static inline __attribute__((always_inline)) void float____temp_buffer____buffer__temp1251v(char** __temp1271v, uint64_t* __temp1272v, uint16_t* __temp1273v, uint16_t* __temp1274v) {
  char* unsafe_ptr=0;
...
static inline __attribute__((always_inline)) int alloc__temp473v(char** __temp1286v, uint64_t* __temp1287v, uint16_t* __temp1288v, uint16_t* __temp1289v, uint64_t size, char** __temp1290v, uint64_t* __temp1291v, uint16_t* __temp1292v, uint16_t* __temp1293v) {
  ...
  *__temp1290v=__temp485v__unsafe_ptr;
  *__temp1291v=__temp485v__unsafe_size;
  *__temp1292v=__temp485v__unsafe_offset;
  *__temp1293v=__temp485v__unsafe_align;
...
static inline __attribute__((always_inline)) int realloc__temp462v(char* allocated, uint64_t bytes, char** __temp1296v) {
  ...
  __temp_failure:__temp_return:
  *__temp1296v=__temp465v__;
  
  return __temp_errcode;
}

static inline __attribute__((always_inline)) void lt__temp247v(uint64_t x, uint64_t y, char* __temp1297v) {
  int __temp248v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) int resize__temp516v(char** __temp1298v, uint64_t* __temp1299v, uint16_t* __temp1300v, uint16_t* __temp1301v, uint64_t size, char** __temp1302v, uint64_t* __temp1303v, uint16_t* __temp1304v, uint16_t* __temp1305v) {
...
static inline __attribute__((always_inline)) void add__temp468v(char* allocated, uint64_t offset, char** __temp1307v) {
  char* element=0;
  char* __temp469v__=0;
  ...
  goto __temp_return;
  __temp_return:
  *__temp1307v=__temp469v__;
}

static inline __attribute__((always_inline)) int mutget__temp543v(char** __temp1308v, uint64_t* __temp1309v, uint16_t* __temp1310v, uint16_t* __temp1311v, uint64_t i, char** __temp1312v) {
  ...
  *__temp1312v=__temp549v__;
  
  return __temp_errcode;
}

static inline __attribute__((always_inline)) void len__temp557v(char* buffer__unsafe_ptr, uint64_t buffer__unsafe_size, uint16_t buffer__unsafe_offset, uint16_t buffer__unsafe_align, uint64_t* __temp1313v) {
  goto __temp_return;
  __temp_return:
...
static inline __attribute__((always_inline)) int get__temp550v(char* buffer__unsafe_ptr, uint64_t buffer__unsafe_size, uint16_t buffer__unsafe_offset, uint16_t buffer__unsafe_align, uint64_t i, char** __temp1314v) {
  char __temp551v__=0;
...
static inline __attribute__((always_inline)) int main__temp1250v() {
  ...
  __temp1258v=10;
  __temp_errcode=resize__temp516v(&__temp1254v__unsafe_ptr,&__temp1254v__unsafe_size,&__temp1254v__unsafe_offset,&__temp1254v__unsafe_align,__temp1258v,&__temp1259v__unsafe_ptr,&__temp1259v__unsafe_size,&__temp1259v__unsafe_offset,&__temp1259v__unsafe_align);
  if(__temp_errcode){
  goto __temp_failure;
  }
  __temp1260v=0;
  __temp_errcode=mutget__temp543v(&__temp1254v__unsafe_ptr,&__temp1254v__unsafe_size,&__temp1254v__unsafe_offset,&__temp1254v__unsafe_align,__temp1260v,&__temp1261v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
  __temp1262v=1.0;
  ...
  len__temp557v(__temp1254v__unsafe_ptr,__temp1254v__unsafe_size,__temp1254v__unsafe_offset,__temp1254v__unsafe_align,&__temp1263v__);
  print__temp376v(__temp1254v__unsafe_size);
  len__temp557v(__temp1254v__unsafe_ptr,__temp1254v__unsafe_size,__temp1254v__unsafe_offset,__temp1254v__unsafe_align,&__temp1265v__);
  print__temp376v(__temp1254v__unsafe_size);
  __temp1267v=0;
  __temp_errcode=get__temp550v(__temp1254v__unsafe_ptr,__temp1254v__unsafe_size,__temp1254v__unsafe_offset,__temp1254v__unsafe_align,__temp1267v,&__temp1268v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
  if(!__temp1268v__){
  ...
  memcpy(&__temp1269v__number,__temp1268v__,8);
  print__temp368v(__temp1269v__number);
