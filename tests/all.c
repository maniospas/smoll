...
int cstr unsafe_tmp__t712t(char* other__unsafe_ptr, uint64_t other__dat__pos, uint64_t other__dat__length, char other__dat__first, const char** __t2006t, char** __t2007t, uint64_t* __t2008t, uint64_t* __t2009t, char* __t2010t) {
...
static inline __attribute__((always_inline)) int read__t1327t(char* cmd__unsafe_ptr, uint64_t cmd__dat__pos, uint64_t cmd__dat__length, char cmd__dat__first, char** __t2017t) {
  ...
  int __t_errcode=0;
  int __t_complain=0;
  __t_errcode=cstr unsafe_tmp__t712t(cmd__unsafe_ptr,cmd__dat__pos,cmd__dat__length,cmd__dat__first,&__t1328t__cstr,&__t1328t__str__unsafe_ptr,&__t1328t__str__dat__pos,&__t1328t__str__dat__length,&__t1328t__str__dat__first);
  if(__t_errcode){
  goto __t_failure;
  }
