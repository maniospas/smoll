...
static inline void print__temp478v(unsigned long long value) {
  const char* __temp479v=0;
  const char* __temp481v=0;
  const char* __temp482v=0;
  const char* endl=0;
  __temp479v="prints an unsigned integer";
  __temp481v="automatically ends the line too";
  __temp482v="\n";
  endl=__temp482v;
  printf("%llu%s",value,endl);
}

static inline void char__temp_buffer__buffer__temp1051v(void** __temp1063v, unsigned long long* __temp1064v, unsigned long long* __temp1065v) {
  void* unsafe_ptr=0;
  unsigned long long unsafe_size=0;
  unsigned long long unsafe_align=0;
  unsafe_align=1;
  *__temp1063v=unsafe_ptr;
  *__temp1064v=unsafe_size;
  *__temp1065v=unsafe_align;
}

static inline void len__temp652v(void* buffer__unsafe_ptr, unsigned long long buffer__unsafe_size, unsigned long long buffer__unsafe_align, unsigned long long* __temp1066v) {
  const char* __temp653v=0;
  __temp653v="the number of buffer elements";
  *__temp1066v=buffer__unsafe_size;
}

static inline void list__temp661v(void** __temp1067v, unsigned long long* __temp1068v, unsigned long long* __temp1069v, void** __temp1070v, unsigned long long* __temp1071v, unsigned long long* __temp1072v, unsigned long long* __temp1073v) {
  void* buffer__unsafe_ptr=*__temp1067v;
  unsigned long long buffer__unsafe_size=*__temp1068v;
  unsigned long long buffer__unsafe_align=*__temp1069v;
  ...
  length=__temp665v__;
  *__temp1067v=buffer__unsafe_ptr;
  *__temp1068v=buffer__unsafe_size;
  *__temp1069v=buffer__unsafe_align;
  *__temp1070v=buffer__unsafe_ptr;
  *__temp1071v=buffer__unsafe_size;
  *__temp1072v=buffer__unsafe_align;
  *__temp1073v=length;
}

static inline void char__temp_buffer__buffer__temp656v(void** __temp1074v, unsigned long long* __temp1075v, unsigned long long* __temp1076v) {
  void* unsafe_ptr=0;
  unsigned long long unsafe_size=0;
  unsigned long long unsafe_align=0;
  unsafe_align=1;
  *__temp1074v=unsafe_ptr;
  *__temp1075v=unsafe_size;
  *__temp1076v=unsafe_align;
}

static inline void false__temp7v(int* __temp1077v) {
  int value=0;
  *__temp1077v=value;
}

static inline void not__temp33v(int __temp_anon0, int* __temp1078v) {
  const char* __temp34v=0;
  int __temp35v__=0;
  __temp34v="logical inverse";
  false__temp7v(&__temp35v__);
  *__temp1078v=__temp35v__;
}

static inline void is_different__temp105v(unsigned long long x, unsigned long long y, int* __temp1079v) {
  int __temp106v=0;
  int __temp107v__=0;
  not__temp33v(__temp106v,&__temp107v__);
  *__temp1079v=__temp107v__;
}

static inline void neq__temp402v(unsigned long long x, unsigned long long y, int* __temp1080v) {
...
static inline void ge__temp336v(unsigned long long x, unsigned long long y, int* __temp1081v) {
...
static inline void mul__temp171v(unsigned long long x, unsigned long long y, unsigned long long* __temp1082v) {
...
static inline void attach_type__temp12v(void* to, void* from, void** __temp1083v) {
  *__temp1083v=to;
}

static inline void add__temp577v(void* allocated, unsigned long long offset, void** __temp1084v) {
  void* element=0;
  void* __temp578v__=0;
  element=((char*)allocated)+offset;
  attach_type__temp12v(element,allocated,&__temp578v__);
  *__temp1084v=__temp578v__;
}

static inline int get__temp647v(void* buffer__unsafe_ptr, unsigned long long buffer__unsafe_size, unsigned long long buffer__unsafe_align, unsigned long long i, void** __temp1085v) {
  ...
  *__temp1085v=__temp651v__;
  
  __temp_failure:
  return __temp_errcode;
}

static inline void str__temp691v(void* buf__unsafe_ptr, unsigned long long buf__unsafe_size, unsigned long long buf__unsafe_align, unsigned long long dat__pos, unsigned long long dat__length, char dat__first, void** __temp1086v, unsigned long long* __temp1087v, unsigned long long* __temp1088v, unsigned long long* __temp1089v, unsigned long long* __temp1090v, char* __temp1091v) {
  const char* __temp692v=0;
  __temp692v="a string residing on a buffer";
  *__temp1086v=buf__unsafe_ptr;
  *__temp1087v=buf__unsafe_size;
  *__temp1088v=buf__unsafe_align;
  *__temp1089v=dat__pos;
  *__temp1090v=dat__length;
  *__temp1091v=dat__first;
}

static inline int str__temp693v(void* buf__unsafe_ptr, unsigned long long buf__unsafe_size, unsigned long long buf__unsafe_align, unsigned long long pos, unsigned long long length, void** __temp1092v, unsigned long long* __temp1093v, unsigned long long* __temp1094v, unsigned long long* __temp1095v, unsigned long long* __temp1096v, char* __temp1097v) {
  ...
  *__temp1092v=__temp699v__buf__unsafe_ptr;
  *__temp1093v=__temp699v__buf__unsafe_size;
  *__temp1094v=__temp699v__buf__unsafe_align;
  *__temp1095v=__temp699v__dat__pos;
  *__temp1096v=__temp699v__dat__length;
  *__temp1097v=__temp699v__dat__first;
  
  __temp_failure:
  return __temp_errcode;
}

static inline int str__temp700v(const char* c, void** __temp1099v, unsigned long long* __temp1100v, unsigned long long* __temp1101v, unsigned long long* __temp1102v, unsigned long long* __temp1103v, char* __temp1104v) {
  ...
  *__temp1099v=__temp705v__buf__unsafe_ptr;
  *__temp1100v=__temp705v__buf__unsafe_size;
  *__temp1101v=__temp705v__buf__unsafe_align;
  *__temp1102v=__temp705v__dat__pos;
  *__temp1103v=__temp705v__dat__length;
  *__temp1104v=__temp705v__dat__first;
  
  __temp_failure:
  return __temp_errcode;
}

static inline void len__temp706v(void* s__buf__unsafe_ptr, unsigned long long s__buf__unsafe_size, unsigned long long s__buf__unsafe_align, unsigned long long s__dat__pos, unsigned long long s__dat__length, char s__dat__first, unsigned long long* __temp1105v) {
  const char* __temp707v=0;
  __temp707v="string length";
  *__temp1105v=s__dat__length;
}

static inline void add__temp138v(unsigned long long x, unsigned long long y, unsigned long long* __temp1106v) {
...
static inline void div__temp204v(unsigned long long x, unsigned long long y, unsigned long long* __temp1107v) {
...
static inline void eq__temp369v(unsigned long long x, unsigned long long y, int* __temp1108v) {
...
static inline void free__temp575v(void** __temp1109v) {
  void* allocated=*__temp1109v;
  if(allocated)free(allocated);
  allocated=0;
  *__temp1109v=allocated;
}

static inline void free__temp581v(void** __temp1110v, unsigned long long* __temp1111v, unsigned long long* __temp1112v, void** __temp1113v, unsigned long long* __temp1114v, unsigned long long* __temp1115v) {
  void* buffer__unsafe_ptr=*__temp1110v;
  unsigned long long buffer__unsafe_size=*__temp1111v;
  unsigned long long buffer__unsafe_align=*__temp1112v;
  ...
  __temp_return:
  *__temp1110v=buffer__unsafe_ptr;
  *__temp1111v=buffer__unsafe_size;
  *__temp1112v=buffer__unsafe_align;
  *__temp1113v=buffer__unsafe_ptr;
  *__temp1114v=buffer__unsafe_size;
  *__temp1115v=buffer__unsafe_align;
}
...
static inline int alloc__temp572v(unsigned long long bytes, void** __temp1116v) {
  void* allocated=0;
  int failed=0;
  int __temp_errcode=0;
...
static inline int alloc__temp587v(void** __temp1117v, unsigned long long* __temp1118v, unsigned long long* __temp1119v, unsigned long long size, void** __temp1120v, unsigned long long* __temp1121v, unsigned long long* __temp1122v) {
...
static inline int realloc__temp573v(void* allocated__unsafe_ptr, unsigned long long bytes, void** __temp1123v) {
  ...
  *__temp1123v=__temp574v__;
  
  __temp_failure:
  return __temp_errcode;
}

static inline void lt__temp237v(unsigned long long x, unsigned long long y, int* __temp1124v) {
...
int resize__temp609v(void** __temp1129v, unsigned long long* __temp1130v, unsigned long long* __temp1131v, unsigned long long size, void** __temp1132v, unsigned long long* __temp1133v, unsigned long long* __temp1134v) {
  void* buffer__unsafe_ptr=*__temp1129v;
  unsigned long long buffer__unsafe_size=*__temp1130v;
  unsigned long long buffer__unsafe_align=*__temp1131v;
  ...
  *__temp1134v=buffer__unsafe_align;
  ...
  __temp_failure:__temp1127v=0;
  neq__temp402v(__temp619v__unsafe_size,__temp1127v,&__temp1128v);
  if(__temp1128v){
...
static inline int copy__temp708v(void** __temp1135v, unsigned long long* __temp1136v, unsigned long long* __temp1137v, unsigned long long* __temp1138v, void* other__buf__unsafe_ptr, unsigned long long other__buf__unsafe_size, unsigned long long other__buf__unsafe_align, unsigned long long other__dat__pos, unsigned long long other__dat__length, char other__dat__first, void** __temp1139v, unsigned long long* __temp1140v, unsigned long long* __temp1141v, unsigned long long* __temp1142v, unsigned long long* __temp1143v, char* __temp1144v) {
  void* buf__unsafe_ptr=*__temp1135v;
  unsigned long long buf__unsafe_size=*__temp1136v;
  unsigned long long buf__unsafe_align=*__temp1137v;
  unsigned long long pos=*__temp1138v;
  ...
  *__temp1135v=buf__unsafe_ptr;
  *__temp1136v=buf__unsafe_size;
  *__temp1137v=buf__unsafe_align;
  *__temp1138v=pos;
  *__temp1139v=__temp717v__buf__unsafe_ptr;
  *__temp1140v=__temp717v__buf__unsafe_size;
  *__temp1141v=__temp717v__buf__unsafe_align;
  *__temp1142v=__temp717v__dat__pos;
  *__temp1143v=__temp717v__dat__length;
  *__temp1144v=__temp717v__dat__first;
  
  __temp_failure:
  return __temp_errcode;
}

int copy__temp753v(void** __temp1147v, unsigned long long* __temp1148v, unsigned long long* __temp1149v, unsigned long long* __temp1150v, const char* _other, void** __temp1151v, unsigned long long* __temp1152v, unsigned long long* __temp1153v, unsigned long long* __temp1154v, unsigned long long* __temp1155v, char* __temp1156v) {
  void* li__buffer__unsafe_ptr=*__temp1147v;
  unsigned long long li__buffer__unsafe_size=*__temp1148v;
  unsigned long long li__buffer__unsafe_align=*__temp1149v;
  unsigned long long li__length=*__temp1150v;
  ...
  *__temp1147v=li__buffer__unsafe_ptr;
  *__temp1148v=li__buffer__unsafe_size;
  *__temp1149v=li__buffer__unsafe_align;
  *__temp1150v=li__length;
  *__temp1151v=__temp769v__buf__unsafe_ptr;
  *__temp1152v=__temp769v__buf__unsafe_size;
  *__temp1153v=__temp769v__buf__unsafe_align;
  *__temp1154v=__temp769v__dat__pos;
  *__temp1155v=__temp769v__dat__length;
  *__temp1156v=__temp769v__dat__first;
  
  __temp_failure:
  return __temp_errcode;
}

static inline int get__temp770v(void* s__buf__unsafe_ptr, unsigned long long s__buf__unsafe_size, unsigned long long s__buf__unsafe_align, unsigned long long s__dat__pos, unsigned long long s__dat__length, char s__dat__first, unsigned long long i, void** __temp1157v) {
  ...
  *__temp1157v=__temp773v__;
  
  __temp_failure:
  return __temp_errcode;
}

static inline void char__temp777v(const char* s, char* __temp1158v) {
...
static inline void eq__temp780v(char x, char y, int* __temp1159v) {
...
static inline void not__temp19v(int value, int* __temp1160v) {
...
static inline void is_different__temp81v(double x, double y, int* __temp1161v) {
  int __temp82v=0;
  int __temp83v__=0;
  not__temp33v(__temp82v,&__temp83v__);
  *__temp1161v=__temp83v__;
}

static inline void mul__temp141v(double x, double y, double* __temp1162v) {
...
static inline void add__temp108v(double x, double y, double* __temp1163v) {
...
static inline void sub__temp405v(double x, double y, double* __temp1164v) {
...
static inline int float__temp922v(void* _s__buf__unsafe_ptr, unsigned long long _s__buf__unsafe_size, unsigned long long _s__buf__unsafe_align, unsigned long long _s__dat__pos, unsigned long long _s__dat__length, char _s__dat__first, double* __temp1166v) {
...
static inline int main__temp1048v() {
  ...
  void* __temp1053v__unsafe_ptr=0;
  unsigned long long __temp1053v__unsafe_size=0;
  unsigned long long __temp1053v__unsafe_align=0;
  void* __temp1054v__buffer__unsafe_ptr=0;
  unsigned long long __temp1054v__buffer__unsafe_size=0;
  unsigned long long __temp1054v__buffer__unsafe_align=0;
  unsigned long long __temp1054v__length=0;
  ...
  double __temp1059v__=0;
  unsigned long long __temp1061v__=0;
  int __temp_errcode=0;
  __temp1049v=1;
  print__temp478v(__temp1049v);
  char__temp_buffer__buffer__temp1051v(&__temp1053v__unsafe_ptr,&__temp1053v__unsafe_size,&__temp1053v__unsafe_align);
  list__temp661v(&__temp1053v__unsafe_ptr,&__temp1053v__unsafe_size,&__temp1053v__unsafe_align,&__temp1054v__buffer__unsafe_ptr,&__temp1054v__buffer__unsafe_size,&__temp1054v__buffer__unsafe_align,&__temp1054v__length);
  mem__buffer__unsafe_ptr=__temp1054v__buffer__unsafe_ptr;
  mem__buffer__unsafe_size=__temp1054v__buffer__unsafe_size;
  mem__buffer__unsafe_align=__temp1054v__buffer__unsafe_align;
  mem__length=__temp1054v__length;
  __temp1055v="123.12";
  ...
  s1__buf__unsafe_ptr=__temp1056v__buf__unsafe_ptr;
  s1__buf__unsafe_size=__temp1056v__buf__unsafe_size;
  s1__buf__unsafe_align=__temp1056v__buf__unsafe_align;
  s1__dat__pos=__temp1056v__dat__pos;
  s1__dat__length=__temp1056v__dat__length;
  s1__dat__first=__temp1056v__dat__first;
  __temp1057v="123.12";
  ...
  s2__buf__unsafe_ptr=__temp1058v__buf__unsafe_ptr;
  s2__buf__unsafe_size=__temp1058v__buf__unsafe_size;
  s2__buf__unsafe_align=__temp1058v__buf__unsafe_align;
  s2__dat__pos=__temp1058v__dat__pos;
  s2__dat__length=__temp1058v__dat__length;
  s2__dat__first=__temp1058v__dat__first;
  __temp_errcode=float__temp922v(s2__buf__unsafe_ptr,s2__buf__unsafe_size,s2__buf__unsafe_align,s2__dat__pos,s2__dat__length,s2__dat__first,&__temp1059v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
  print__temp462v(__temp1059v__);
  len__temp652v(mem__buffer__unsafe_ptr,mem__buffer__unsafe_size,mem__buffer__unsafe_align,&__temp1061v__);
  print__temp478v(__temp1061v__);
