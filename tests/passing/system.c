...
int __temp_argc;
char** __temp_argv;
const char* const __temp1735v="ls";
...
static inline __attribute__((always_inline)) void char____temp_buffer____buffer__temp557v(char** __temp1739v, uint64_t* __temp1740v, uint16_t* __temp1741v, uint16_t* __temp1742v) {
  char* unsafe_ptr=0;
...
static inline __attribute__((always_inline)) int alloc__temp556v(uint64_t size, char** __temp1761v, uint64_t* __temp1762v, uint16_t* __temp1763v, uint16_t* __temp1764v) {
  ...
  __temp_return:
  *__temp1761v=__temp561v__unsafe_ptr;
  *__temp1762v=__temp561v__unsafe_size;
  *__temp1763v=__temp561v__unsafe_offset;
  *__temp1764v=__temp561v__unsafe_align;
  
  return __temp_errcode;
}

static inline __attribute__((always_inline)) void attach_type__temp21v(char* to, const char* from, char** __temp1765v) {
  *__temp1765v=to;
}
...
static inline __attribute__((always_inline)) void ge__temp319v(uint64_t x, uint64_t y, char* __temp1767v) {
  int __temp320v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void attach_type__temp20v(char* to, char* from, char** __temp1768v) {
  *__temp1768v=to;
}

static inline __attribute__((always_inline)) void add__temp463v(char* allocated, uint64_t offset, char** __temp1769v) {
  char* element=0;
  char* __temp464v__=0;
  ...
  goto __temp_return;
  __temp_return:
  *__temp1769v=__temp464v__;
}

static inline __attribute__((always_inline)) int get__temp548v(char* buffer__unsafe_ptr, uint64_t buffer__unsafe_size, uint16_t buffer__unsafe_offset, uint16_t buffer__unsafe_align, uint64_t i, char** __temp1770v) {
  char __temp549v__=0;
  ...
  __temp_failure:__temp_return:
  *__temp1770v=__temp554v__;
  
  return __temp_errcode;
}

static inline __attribute__((always_inline)) void str__temp593v(char* unsafe_ptr, uint64_t dat__pos, uint64_t dat__length, char dat__first, char** __temp1771v, uint64_t* __temp1772v, uint64_t* __temp1773v, char* __temp1774v) {
  goto __temp_return;
  __temp_return:
  *__temp1771v=unsafe_ptr;
  *__temp1772v=dat__pos;
  *__temp1773v=dat__length;
  *__temp1774v=dat__first;
}

static inline __attribute__((always_inline)) int str__temp597v(char* buf__unsafe_ptr, uint64_t buf__unsafe_size, uint16_t buf__unsafe_offset, uint16_t buf__unsafe_align, uint64_t dat__pos, uint64_t dat__length, char dat__first, char** __temp1775v, uint64_t* __temp1776v, uint64_t* __temp1777v, char* __temp1778v) {
  char* unsafe_ptr=0;
  ...
  __temp_failure:__temp_return:
  *__temp1775v=__temp604v__unsafe_ptr;
  *__temp1776v=__temp604v__dat__pos;
  *__temp1777v=__temp604v__dat__length;
  *__temp1778v=__temp604v__dat__first;
  
  return __temp_errcode;
}

static inline __attribute__((always_inline)) int str__temp629v(char* buf__unsafe_ptr, uint64_t buf__unsafe_size, uint16_t buf__unsafe_offset, uint16_t buf__unsafe_align, uint64_t pos, uint64_t length, char** __temp1779v, uint64_t* __temp1780v, uint64_t* __temp1781v, char* __temp1782v) {
  ...
  __temp_failure:__temp_return:
  *__temp1779v=__temp634v__unsafe_ptr;
  *__temp1780v=__temp634v__dat__pos;
  *__temp1781v=__temp634v__dat__length;
  *__temp1782v=__temp634v__dat__first;
  
  return __temp_errcode;
}

int str__temp635v(const char* c, char** __temp1783v, uint64_t* __temp1784v, uint64_t* __temp1785v, char* __temp1786v) {
  ...
  __temp_failure:__temp_return:
  *__temp1783v=__temp642v__unsafe_ptr;
  *__temp1784v=__temp642v__dat__pos;
  *__temp1785v=__temp642v__dat__length;
  *__temp1786v=__temp642v__dat__first;
  
  return __temp_errcode;
}

static inline __attribute__((always_inline)) void str__temp628v(char* other__unsafe_ptr, uint64_t other__dat__pos, uint64_t other__dat__length, char other__dat__first, char** __temp1787v, uint64_t* __temp1788v, uint64_t* __temp1789v, char* __temp1790v) {
  goto __temp_return;
  __temp_return:
  *__temp1787v=other__unsafe_ptr;
  *__temp1788v=other__dat__pos;
  *__temp1789v=other__dat__length;
  *__temp1790v=other__dat__first;
}

static inline __attribute__((always_inline)) void len__temp643v(char* s__unsafe_ptr, uint64_t s__dat__pos, uint64_t s__dat__length, char s__dat__first, uint64_t* __temp1791v) {
  goto __temp_return;
  __temp_return:
  *__temp1791v=s__dat__length;
}

static inline __attribute__((always_inline)) void len__temp555v(char* buffer__unsafe_ptr, uint64_t buffer__unsafe_size, uint16_t buffer__unsafe_offset, uint16_t buffer__unsafe_align, uint64_t* __temp1792v) {
  goto __temp_return;
  __temp_return:
...
static inline __attribute__((always_inline)) int copy__temp700v(char** __temp1794v, uint64_t* __temp1795v, uint16_t* __temp1796v, uint16_t* __temp1797v, uint64_t* __temp1798v, char* _other__unsafe_ptr, uint64_t _other__dat__pos, uint64_t _other__dat__length, char _other__dat__first, char** __temp1799v, uint64_t* __temp1800v, uint64_t* __temp1801v, char* __temp1802v) {
  char* buf__unsafe_ptr=*__temp1794v;
  uint64_t buf__unsafe_size=*__temp1795v;
  uint16_t buf__unsafe_offset=*__temp1796v;
  uint16_t buf__unsafe_align=*__temp1797v;
  ...
  *__temp1796v=buf__unsafe_offset;
  *__temp1797v=buf__unsafe_align;
  *__temp1798v=pos;
  *__temp1799v=__temp708v__unsafe_ptr;
  *__temp1800v=__temp708v__dat__pos;
  *__temp1801v=__temp708v__dat__length;
  *__temp1802v=__temp708v__dat__first;
  
  return __temp_errcode;
}

static inline __attribute__((always_inline)) int copy_null_terminated__temp662v(char* other__unsafe_ptr, uint64_t other__dat__pos, uint64_t other__dat__length, char other__dat__first, char** __temp1803v, uint64_t* __temp1804v, uint64_t* __temp1805v, char* __temp1806v) {
  ...
  *endpos=0;
  ...
  __temp_return:
  *__temp1803v=__temp669v__unsafe_ptr;
  *__temp1804v=__temp669v__dat__pos;
  *__temp1805v=__temp669v__dat__length;
  *__temp1806v=__temp669v__dat__first;
  
  return __temp_errcode;
}

int temporary_cstr__temp670v(char* other__unsafe_ptr, uint64_t other__dat__pos, uint64_t other__dat__length, char other__dat__first, const char** __temp1807v, char** __temp1808v, uint64_t* __temp1809v, uint64_t* __temp1810v, char* __temp1811v) {
  ...
  __temp_return:
  *__temp1807v=cstr;
  *__temp1808v=str__unsafe_ptr;
  *__temp1809v=str__dat__pos;
  *__temp1810v=str__dat__length;
  *__temp1811v=str__dat__first;
  
  return __temp_errcode;
}

static inline __attribute__((always_inline)) int safe__temp1308v(const char* cmd, const char** __temp1812v) {
  char unsafe_chars=0;
  int __temp_errcode=0;
  int __temp_complain=0;
  unsafe_chars=0;
...
static inline __attribute__((always_inline)) void system_return__temp1307v(const char* cmd, int64_t* __temp1813v) {
  int64_t result=0;
  result=system(cmd);
  goto __temp_return;
  __temp_return:
...
static inline __attribute__((always_inline)) void int__temp395v(uint64_t x, int64_t* __temp1814v) {
  int64_t z=0;
  z=x;
  goto __temp_return;
  __temp_return:
...
static inline __attribute__((always_inline)) void is_different__temp81v(int64_t x, int64_t y, int* __temp1815v) {
  int __temp82v=0;
  int __temp83v__=0;
  not__temp35v(__temp82v,&__temp83v__);
  goto __temp_return;
  __temp_return:
  *__temp1815v=__temp83v__;
}

static inline __attribute__((always_inline)) void neq__temp131v(int64_t x, int64_t y, char* __temp1816v) {
  int __temp132v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) int main__temp1728v() {
  ...
  uint64_t __temp1730v__unsafe_size=0;
  uint16_t __temp1730v__unsafe_offset=0;
  uint16_t __temp1730v__unsafe_align=0;
  char __temp1731v____temp562v____temp470v__=0;
  ...
  int __temp_complain=0;
  __temp1729v=2;
  __temp_errcode=alloc__temp556v(__temp1729v,&__temp1730v__unsafe_ptr,&__temp1730v__unsafe_size,&__temp1730v__unsafe_offset,&__temp1730v__unsafe_align);
  if(__temp_errcode){
  goto __temp_failure;
  }
  __temp1732v__unsafe_ptr=__temp1730v__unsafe_ptr;
  __temp1732v__unsafe_size=__temp1730v__unsafe_size;
  __temp1732v__unsafe_offset=__temp1730v__unsafe_offset;
  __temp1732v__unsafe_align=__temp1730v__unsafe_align;
  buf__unsafe_ptr=__temp1732v__unsafe_ptr;
  buf__unsafe_size=__temp1732v__unsafe_size;
  buf__unsafe_offset=__temp1732v__unsafe_offset;
  buf__unsafe_align=__temp1732v__unsafe_align;
  __temp1733v=0;
  __temp1734v=__temp1733v;
  __temp_errcode=str__temp635v(__temp1735v,&__temp1736v__unsafe_ptr,&__temp1736v__dat__pos,&__temp1736v__dat__length,&__temp1736v__dat__first);
  if(__temp_errcode){
  goto __temp_failure;
  }
  __temp_errcode=copy__temp700v(&buf__unsafe_ptr,&buf__unsafe_size,&buf__unsafe_offset,&buf__unsafe_align,&__temp1734v,__temp1736v__unsafe_ptr,__temp1736v__dat__pos,__temp1736v__dat__length,__temp1736v__dat__first,&__temp1737v__unsafe_ptr,&__temp1737v__dat__pos,&__temp1737v__dat__length,&__temp1737v__dat__first);
  if(__temp_errcode){
  goto __temp_failure;
  }
  s__unsafe_ptr=__temp1737v__unsafe_ptr;
  s__dat__pos=__temp1737v__dat__pos;
  s__dat__length=__temp1737v__dat__length;
  s__dat__first=__temp1737v__dat__first;
  __temp_errcode=system__temp1316v(s__unsafe_ptr,s__dat__pos,s__dat__length,s__dat__first);
  if(__temp_errcode){
  goto __temp_failure;
  }
  
  __temp_failure:exists__temp412v(__temp1730v__unsafe_ptr,&__temp1731v____temp562v____temp470v__);
  if(__temp1731v____temp562v____temp470v__){
  __temp1730v__unsafe_size=0;
  __temp1730v__unsafe_size=__temp1730v__unsafe_size;
  free__temp461v(&__temp1730v__unsafe_ptr);
  }
