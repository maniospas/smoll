...
static inline __attribute__((always_inline)) void char____t_buffer____buffer__t1345t(char** __t1879t, uint64_t* __t1880t, uint16_t* __t1881t, uint16_t* __t1882t) {
  char* unsafe_ptr=0;
  ...
  unsafe_align=1;
  *__t1879t=unsafe_ptr;
  *__t1880t=unsafe_size;
  *__t1881t=unsafe_offset;
  *__t1882t=unsafe_align;
}

static inline __attribute__((always_inline)) void exists__t436t(char* x, char* __t1883t) {
  char z=0;
  z=x!=0;
  goto __t_return;
  __t_return:
...
static inline __attribute__((always_inline)) void free__t502t(char** __t1884t) {
  char* allocated=*__t1884t;
  if(allocated){
  free(allocated);
  }
  *__t1884t=allocated;
...
static inline __attribute__((always_inline)) void not__t36t(int __t_anon0, int* __t1886t) {
  int __t37t__=0;
...
static inline __attribute__((always_inline)) void is_different__t94t(uint64_t x, uint64_t y, int* __t1887t) {
  int __t95t=0;
  int __t96t__=0;
...
static inline __attribute__((always_inline)) void eq__t119t(uint64_t x, uint64_t y, char* __t1888t) {
  int __t120t__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void neq__t143t(uint64_t x, uint64_t y, char* __t1889t) {
  int __t144t__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void nat__t506t(uint16_t x, uint64_t* __t1890t) {
  uint64_t value=0;
  value=x;
  goto __t_return;
  __t_return:
...
static inline __attribute__((always_inline)) void mul__t195t(uint64_t x, uint64_t y, uint64_t* __t1891t) {
  int __t196t__=0;
  uint64_t z=0;
...
static inline __attribute__((always_inline)) void char____t_buffer____buffer__t551t(char** __t1902t, uint64_t* __t1903t, uint16_t* __t1904t, uint16_t* __t1905t) {
  char* unsafe_ptr=0;
  uint64_t unsafe_size=0;
  uint16_t unsafe_offset=0;
  uint16_t unsafe_align=0;
  unsafe_align=1;
  *__t1902t=unsafe_ptr;
  *__t1903t=unsafe_size;
  *__t1904t=unsafe_offset;
  *__t1905t=unsafe_align;
}

static inline __attribute__((always_inline)) void attach_type__t22t(char* to, const char* from, char** __t1906t) {
  *__t1906t=to;
}

static inline __attribute__((always_inline)) void add__t171t(uint64_t x, uint64_t y, uint64_t* __t1907t) {
  int __t172t__=0;
  uint64_t z=0;
...
static inline __attribute__((always_inline)) void ge__t320t(uint64_t x, uint64_t y, char* __t1908t) {
  int __t321t__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void attach_type__t21t(char* to, char* from, char** __t1909t) {
  *__t1909t=to;
}

static inline __attribute__((always_inline)) void add__t504t(char* allocated, uint64_t offset, char** __t1910t) {
  char* element=0;
  char* __t505t__=0;
...
static inline __attribute__((always_inline)) int get__t591t(char* buffer__unsafe_ptr, uint64_t buffer__unsafe_size, uint16_t buffer__unsafe_offset, uint16_t buffer__unsafe_align, uint64_t i, char** __t1911t) {
  char __t592t__=0;
...
static inline __attribute__((always_inline)) void str__t626t(char* unsafe_ptr, uint64_t dat__pos, uint64_t dat__length, char dat__first, char** __t1912t, uint64_t* __t1913t, uint64_t* __t1914t, char* __t1915t) {
  goto __t_return;
  __t_return:
  *__t1912t=unsafe_ptr;
  *__t1913t=dat__pos;
  *__t1914t=dat__length;
  *__t1915t=dat__first;
}

static inline __attribute__((always_inline)) int str__t630t(char* buf__unsafe_ptr, uint64_t buf__unsafe_size, uint16_t buf__unsafe_offset, uint16_t buf__unsafe_align, uint64_t dat__pos, uint64_t dat__length, char dat__first, char** __t1916t, uint64_t* __t1917t, uint64_t* __t1918t, char* __t1919t) {
  char* unsafe_ptr=0;
  ...
  __t_failure:__t_return:
  *__t1916t=__t637t__unsafe_ptr;
  *__t1917t=__t637t__dat__pos;
  *__t1918t=__t637t__dat__length;
  *__t1919t=__t637t__dat__first;
  
  return __t_errcode;
}

static inline __attribute__((always_inline)) int str__t662t(char* buf__unsafe_ptr, uint64_t buf__unsafe_size, uint16_t buf__unsafe_offset, uint16_t buf__unsafe_align, uint64_t pos, uint64_t length, char** __t1920t, uint64_t* __t1921t, uint64_t* __t1922t, char* __t1923t) {
  uint64_t __t663t=0;
  char __t664t__=0;
  char* __t665t__=0;
  ...
  __t_failure:__t_return:
  *__t1920t=__t667t__unsafe_ptr;
  *__t1921t=__t667t__dat__pos;
  *__t1922t=__t667t__dat__length;
  *__t1923t=__t667t__dat__first;
  
  return __t_errcode;
}

int str__t668t(const char* c, char** __t1924t, uint64_t* __t1925t, uint64_t* __t1926t, char* __t1927t) {
  ...
  __t_failure:__t_return:
  *__t1924t=__t675t__unsafe_ptr;
  *__t1925t=__t675t__dat__pos;
  *__t1926t=__t675t__dat__length;
  *__t1927t=__t675t__dat__first;
  
  return __t_errcode;
}

static inline __attribute__((always_inline)) void str__t661t(char* other__unsafe_ptr, uint64_t other__dat__pos, uint64_t other__dat__length, char other__dat__first, char** __t1928t, uint64_t* __t1929t, uint64_t* __t1930t, char* __t1931t) {
  goto __t_return;
  __t_return:
  *__t1928t=other__unsafe_ptr;
  *__t1929t=other__dat__pos;
  *__t1930t=other__dat__length;
  *__t1931t=other__dat__first;
}

static inline __attribute__((always_inline)) void len__t676t(char* s__unsafe_ptr, uint64_t s__dat__pos, uint64_t s__dat__length, char s__dat__first, uint64_t* __t1932t) {
  goto __t_return;
  __t_return:
  *__t1932t=s__dat__length;
}

static inline __attribute__((always_inline)) void len__t598t(char* buffer__unsafe_ptr, uint64_t buffer__unsafe_size, uint16_t buffer__unsafe_offset, uint16_t buffer__unsafe_align, uint64_t* __t1933t) {
  goto __t_return;
  __t_return:
  *__t1933t=buffer__unsafe_size;
}

static inline __attribute__((always_inline)) void gt__t272t(uint64_t x, uint64_t y, char* __t1934t) {
  int __t273t__=0;
  char z=0;
...
static inline __attribute__((always_inline)) int copy__t738t(char** __t1935t, uint64_t* __t1936t, uint16_t* __t1937t, uint16_t* __t1938t, uint64_t* __t1939t, char* _other__unsafe_ptr, uint64_t _other__dat__pos, uint64_t _other__dat__length, char _other__dat__first, char** __t1940t, uint64_t* __t1941t, uint64_t* __t1942t, char* __t1943t) {
  ...
  *__t1939t=pos;
  *__t1940t=__t746t__unsafe_ptr;
  *__t1941t=__t746t__dat__pos;
  *__t1942t=__t746t__dat__length;
  *__t1943t=__t746t__dat__first;
  
  return __t_errcode;
}

static inline __attribute__((always_inline)) int copy_null_terminated__t699t(char* other__unsafe_ptr, uint64_t other__dat__pos, uint64_t other__dat__length, char other__dat__first, char** __t1944t, uint64_t* __t1945t, uint64_t* __t1946t, char* __t1947t) {
  ...
  *endpos=0;
  ...
  __t_return:
  *__t1944t=__t708t__unsafe_ptr;
  *__t1945t=__t708t__dat__pos;
  *__t1946t=__t708t__dat__length;
  *__t1947t=__t708t__dat__first;
  
  return __t_errcode;
}

int unsafe_temp__t709t(char* other__unsafe_ptr, uint64_t other__dat__pos, uint64_t other__dat__length, char other__dat__first, const char** __t1948t, char** __t1949t, uint64_t* __t1950t, uint64_t* __t1951t, char* __t1952t) {
  ...
  __t_return:
  *__t1948t=cstr;
  *__t1949t=str__unsafe_ptr;
  *__t1950t=str__dat__pos;
  *__t1951t=str__dat__length;
  *__t1952t=str__dat__first;
  
  return __t_errcode;
}

static inline __attribute__((always_inline)) void cstr__t716t(const char* value__cstr, char* value__str__unsafe_ptr, uint64_t value__str__dat__pos, uint64_t value__str__dat__length, char value__str__dat__first, const char** __t1953t) {
  goto __t_return;
  __t_return:
  *__t1953t=value__cstr;
}

static inline __attribute__((always_inline)) int safe__t1384t(const char* cmd, const char** __t1954t) {
  char unsafe_chars=0;
  int __t_errcode=0;
  int __t_complain=0;
  unsafe_chars=0;
...
static inline __attribute__((always_inline)) void system_return__t1383t(const char* cmd, int64_t* __t1955t) {
  int64_t result=0;
  result=system(cmd);
  goto __t_return;
  __t_return:
...
static inline __attribute__((always_inline)) void int__t416t(uint64_t x, int64_t* __t1956t) {
  int __t417t=0;
  int __t418t=0;
  int __t419t=0;
  int64_t z=0;
...
static inline __attribute__((always_inline)) void is_different__t82t(int64_t x, int64_t y, int* __t1957t) {
  int __t83t=0;
  int __t84t__=0;
...
static inline __attribute__((always_inline)) void neq__t132t(int64_t x, int64_t y, char* __t1958t) {
  int __t133t__=0;
  char z=0;
...
static inline __attribute__((always_inline)) int main__t1868t() {
  ...
  int __t_errcode=0;
  int __t_complain=0;
  char____t_buffer____buffer__t1345t(&__t1869t__unsafe_ptr,&__t1869t__unsafe_size,&__t1869t__unsafe_offset,&__t1869t__unsafe_align);
  __t1870t=2;
  __t_errcode=alloc__t509t(&__t1869t__unsafe_ptr,&__t1869t__unsafe_size,&__t1869t__unsafe_offset,&__t1869t__unsafe_align,__t1870t,&__t1871t__unsafe_ptr,&__t1871t__unsafe_size,&__t1871t__unsafe_offset,&__t1871t__unsafe_align);
  if(__t_errcode){
  goto __t_failure;
  }
  buf__unsafe_ptr=__t1871t__unsafe_ptr;
  buf__unsafe_size=__t1871t__unsafe_size;
  buf__unsafe_offset=__t1871t__unsafe_offset;
  buf__unsafe_align=__t1871t__unsafe_align;
  __t1873t=0;
  __t1874t=__t1873t;
  __t_errcode=str__t668t(__t1875t,&__t1876t__unsafe_ptr,&__t1876t__dat__pos,&__t1876t__dat__length,&__t1876t__dat__first);
  if(__t_errcode){
  goto __t_failure;
  }
  __t_errcode=copy__t738t(&buf__unsafe_ptr,&buf__unsafe_size,&buf__unsafe_offset,&buf__unsafe_align,&__t1874t,__t1876t__unsafe_ptr,__t1876t__dat__pos,__t1876t__dat__length,__t1876t__dat__first,&__t1877t__unsafe_ptr,&__t1877t__dat__pos,&__t1877t__dat__length,&__t1877t__dat__first);
  if(__t_errcode){
  goto __t_failure;
  }
  s__unsafe_ptr=__t1877t__unsafe_ptr;
  s__dat__pos=__t1877t__dat__pos;
  s__dat__length=__t1877t__dat__length;
  s__dat__first=__t1877t__dat__first;
  __t_errcode=system__t1393t(s__unsafe_ptr,s__dat__pos,s__dat__length,s__dat__first);
  if(__t_errcode){
  goto __t_failure;
  }
  
  __t_failure:exists__t436t(__t1871t__unsafe_ptr,&__t1872t____t511t__);
  if(__t1872t____t511t__){
  free__t502t(&__t1871t__unsafe_ptr);
  }
