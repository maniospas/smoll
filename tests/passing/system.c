...
const char* const __temp1650v="ls";
...
static inline __attribute__((always_inline)) void char__temp_buffer__buffer__temp488v(char** __temp1654v, unsigned long long* __temp1655v, unsigned long long* __temp1656v) {
  char* unsafe_ptr=0;
...
static inline __attribute__((always_inline)) void neq__temp302v(unsigned long long x, unsigned long long y, char* __temp1660v) {
  int __temp303v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void free__temp428v(char** __temp1661v) {
  char* allocated=*__temp1661v;
  if(allocated)free(allocated);
  allocated=0;
  *__temp1661v=allocated;
}

static inline __attribute__((always_inline)) void eq__temp278v(unsigned long long x, unsigned long long y, char* __temp1662v) {
  int __temp279v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) int alloc__temp425v(unsigned long long bytes, char** __temp1664v) {
  char* allocated=0;
  char failed=0;
...
static inline __attribute__((always_inline)) int alloc__temp434v(char** __temp1665v, unsigned long long* __temp1666v, unsigned long long* __temp1667v, unsigned long long size, char** __temp1668v, unsigned long long* __temp1669v, unsigned long long* __temp1670v) {
  char* buffer__unsafe_ptr=*__temp1665v;
...
static inline __attribute__((always_inline)) int alloc__temp487v(unsigned long long size, char** __temp1675v, unsigned long long* __temp1676v, unsigned long long* __temp1677v) {
  ...
  *__temp1675v=__temp492v__unsafe_ptr;
  *__temp1676v=__temp492v__unsafe_size;
  *__temp1677v=__temp492v__unsafe_align;
  
  __temp_failure:
  return __temp_errcode;
}

static inline __attribute__((always_inline)) void ge__temp254v(unsigned long long x, unsigned long long y, char* __temp1678v) {
  int __temp255v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void attach_type__temp13v(char* to, char* from, char** __temp1679v) {
  *__temp1679v=to;
}

static inline __attribute__((always_inline)) void add__temp430v(char* allocated, unsigned long long offset, char** __temp1680v) {
  char* element=0;
  char* __temp431v__=0;
  element=allocated+offset;
  attach_type__temp13v(element,allocated,&__temp431v__);
  *__temp1680v=__temp431v__;
}

static inline __attribute__((always_inline)) int get__temp482v(char* buffer__unsafe_ptr, unsigned long long buffer__unsafe_size, unsigned long long buffer__unsafe_align, unsigned long long i, char** __temp1681v) {
  char __temp483v__=0;
  ...
  *__temp1681v=__temp485v__;
  
  __temp_failure:
  return __temp_errcode;
}

static inline __attribute__((always_inline)) void str__temp518v(char* buf__unsafe_ptr, unsigned long long buf__unsafe_size, unsigned long long buf__unsafe_align, unsigned long long dat__pos, unsigned long long dat__length, char dat__first, char** __temp1682v, unsigned long long* __temp1683v, unsigned long long* __temp1684v, unsigned long long* __temp1685v, unsigned long long* __temp1686v, char* __temp1687v) {
...
static inline __attribute__((always_inline)) int str__temp528v(char* buf__unsafe_ptr, unsigned long long buf__unsafe_size, unsigned long long buf__unsafe_align, unsigned long long pos, unsigned long long length, char** __temp1688v, unsigned long long* __temp1689v, unsigned long long* __temp1690v, unsigned long long* __temp1691v, unsigned long long* __temp1692v, char* __temp1693v) {
  ...
  *__temp1688v=__temp533v__buf__unsafe_ptr;
  *__temp1689v=__temp533v__buf__unsafe_size;
  *__temp1690v=__temp533v__buf__unsafe_align;
  *__temp1691v=__temp533v__dat__pos;
  *__temp1692v=__temp533v__dat__length;
  *__temp1693v=__temp533v__dat__first;
  
  __temp_failure:
  return __temp_errcode;
}

static inline __attribute__((always_inline)) int str__temp534v(const char* c, char** __temp1695v, unsigned long long* __temp1696v, unsigned long long* __temp1697v, unsigned long long* __temp1698v, unsigned long long* __temp1699v, char* __temp1700v) {
  ...
  *__temp1695v=__temp537v__buf__unsafe_ptr;
  *__temp1696v=__temp537v__buf__unsafe_size;
  *__temp1697v=__temp537v__buf__unsafe_align;
  *__temp1698v=__temp537v__dat__pos;
  *__temp1699v=__temp537v__dat__length;
  *__temp1700v=__temp537v__dat__first;
  
  __temp_failure:
  return __temp_errcode;
}

static inline __attribute__((always_inline)) void str__temp527v(char* other__buf__unsafe_ptr, unsigned long long other__buf__unsafe_size, unsigned long long other__buf__unsafe_align, unsigned long long other__dat__pos, unsigned long long other__dat__length, char other__dat__first, char** __temp1701v, unsigned long long* __temp1702v, unsigned long long* __temp1703v, unsigned long long* __temp1704v, unsigned long long* __temp1705v, char* __temp1706v) {
  *__temp1701v=other__buf__unsafe_ptr;
  *__temp1702v=other__buf__unsafe_size;
  *__temp1703v=other__buf__unsafe_align;
  *__temp1704v=other__dat__pos;
  *__temp1705v=other__dat__length;
  *__temp1706v=other__dat__first;
}

static inline __attribute__((always_inline)) void len__temp538v(char* s__buf__unsafe_ptr, unsigned long long s__buf__unsafe_size, unsigned long long s__buf__unsafe_align, unsigned long long s__dat__pos, unsigned long long s__dat__length, char s__dat__first, unsigned long long* __temp1707v) {
...
static inline __attribute__((always_inline)) void len__temp486v(char* buffer__unsafe_ptr, unsigned long long buffer__unsafe_size, unsigned long long buffer__unsafe_align, unsigned long long* __temp1709v) {
  *__temp1709v=buffer__unsafe_size;
}

static inline __attribute__((always_inline)) void gt__temp206v(unsigned long long x, unsigned long long y, char* __temp1710v) {
  int __temp207v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) int copy__temp650v(char** __temp1713v, unsigned long long* __temp1714v, unsigned long long* __temp1715v, unsigned long long* __temp1716v, char* _other__buf__unsafe_ptr, unsigned long long _other__buf__unsafe_size, unsigned long long _other__buf__unsafe_align, unsigned long long _other__dat__pos, unsigned long long _other__dat__length, char _other__dat__first, char** __temp1717v, unsigned long long* __temp1718v, unsigned long long* __temp1719v, unsigned long long* __temp1720v, unsigned long long* __temp1721v, char* __temp1722v) {
  char* buf__unsafe_ptr=*__temp1713v;
  unsigned long long buf__unsafe_size=*__temp1714v;
  unsigned long long buf__unsafe_align=*__temp1715v;
  unsigned long long pos=*__temp1716v;
  ...
  *__temp1713v=buf__unsafe_ptr;
  *__temp1714v=buf__unsafe_size;
  *__temp1715v=buf__unsafe_align;
  *__temp1716v=pos;
  *__temp1717v=__temp658v__buf__unsafe_ptr;
  *__temp1718v=__temp658v__buf__unsafe_size;
  *__temp1719v=__temp658v__buf__unsafe_align;
  *__temp1720v=__temp658v__dat__pos;
  *__temp1721v=__temp658v__dat__length;
  *__temp1722v=__temp658v__dat__first;
  
  __temp_failure:
  return __temp_errcode;
}

static inline __attribute__((always_inline)) void le__temp230v(unsigned long long x, unsigned long long y, char* __temp1723v) {
  int __temp231v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void lt__temp182v(unsigned long long x, unsigned long long y, char* __temp1724v) {
  int __temp183v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) int sub__temp330v(unsigned long long x, unsigned long long y, unsigned long long* __temp1725v) {
  int __temp331v__=0;
  char __temp334v__=0;
  unsigned long long z=0;
  int __temp_errcode=0;
...
static inline __attribute__((always_inline)) void char__temp540v(const char* s, char* __temp1726v) {
  char c=0;
  c=s?s[0]:0;
  *__temp1726v=c;
}

static inline __attribute__((always_inline)) void eq__temp541v(char x, char y, char* __temp1727v) {
  char z=0;
  z=(x==y);
  *__temp1727v=z;
}
...
static inline __attribute__((always_inline)) int copy_null_terminated__temp557v(char* other__buf__unsafe_ptr, unsigned long long other__buf__unsafe_size, unsigned long long other__buf__unsafe_align, unsigned long long other__dat__pos, unsigned long long other__dat__length, char other__dat__first, char** __temp1731v, unsigned long long* __temp1732v, unsigned long long* __temp1733v, unsigned long long* __temp1734v, unsigned long long* __temp1735v, char* __temp1736v) {
  ...
  *__temp1731v=__temp564v__buf__unsafe_ptr;
  *__temp1732v=__temp564v__buf__unsafe_size;
  *__temp1733v=__temp564v__buf__unsafe_align;
  *__temp1734v=__temp564v__dat__pos;
  *__temp1735v=__temp564v__dat__length;
  *__temp1736v=__temp564v__dat__first;
  
  __temp_failure:
  return __temp_errcode;
}

static inline __attribute__((always_inline)) void exists__temp516v(const char* c, char* __temp1737v) {
  char z=0;
  z=c!=0;
  *__temp1737v=z;
}
...
int unsafe_temporary_cstr__temp565v(char* other__buf__unsafe_ptr, unsigned long long other__buf__unsafe_size, unsigned long long other__buf__unsafe_align, unsigned long long other__dat__pos, unsigned long long other__dat__length, char other__dat__first, const char** __temp1743v) {
  ...
  char __temp589v__=0;
  char __temp590v__=0;
  unsigned long long __temp1741v=0;
  char __temp1742v=0;
  int __temp_errcode=0;
  int __temp_complain=0;
...
static inline __attribute__((always_inline)) void int__temp382v(unsigned long long x, long long int* __temp1744v) {
  long long int z=0;
  z=x;
  *__temp1744v=z;
}

static inline __attribute__((always_inline)) void is_different__temp73v(long long int x, long long int y, int* __temp1745v) {
  int __temp74v=0;
  int __temp75v__=0;
  not__temp27v(__temp74v,&__temp75v__);
  *__temp1745v=__temp75v__;
}

static inline __attribute__((always_inline)) void neq__temp291v(long long int x, long long int y, char* __temp1746v) {
  int __temp292v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) int system__temp1294v(char* _cmd__buf__unsafe_ptr, unsigned long long _cmd__buf__unsafe_size, unsigned long long _cmd__buf__unsafe_align, unsigned long long _cmd__dat__pos, unsigned long long _cmd__dat__length, char _cmd__dat__first) {
  const char* __temp1295v__=0;
  const char* cmd=0;
  long long int result=0;
  unsigned long long __temp1297v=0;
  long long int __temp1298v__=0;
  ...
  int __temp_errcode=0;
  int __temp_complain=0;
  __temp_errcode=unsafe_temporary_cstr__temp565v(_cmd__buf__unsafe_ptr,_cmd__buf__unsafe_size,_cmd__buf__unsafe_align,_cmd__dat__pos,_cmd__dat__length,_cmd__dat__first,&__temp1295v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
  cmd=__temp1295v__;
  ...
  __temp1297v=0;
  int__temp382v(__temp1297v,&__temp1298v__);
  neq__temp291v(result,__temp1298v__,&__temp1299v__);
  if(__temp1299v__){
  __temp_errcode=31;
  goto __temp_failure;
  }
  
  __temp_failure:exists__temp516v(__temp1295v__,&__temp1747v);
  not__temp18v(__temp1747v,&__temp1748v);
  if(__temp1748v){
  __temp1749v=0;
  neq__temp302v(__temp1750v,__temp1749v,&__temp1751v);
  if(__temp1751v){
  __temp1750v=0;
  free__temp428v(&__temp1752v);
  }
  }
...
static inline __attribute__((always_inline)) int main__temp1643v() {
  ...
  char* __temp1651v__buf__unsafe_ptr=0;
  ...
  int __temp_complain=0;
  __temp1644v=2;
  __temp_errcode=alloc__temp487v(__temp1644v,&__temp1645v__unsafe_ptr,&__temp1645v__unsafe_size,&__temp1645v__unsafe_align);
  if(__temp_errcode){
  goto __temp_failure;
  }
  __temp1647v__unsafe_ptr=__temp1645v__unsafe_ptr;
  __temp1647v__unsafe_size=__temp1645v__unsafe_size;
  __temp1647v__unsafe_align=__temp1645v__unsafe_align;
  buf__unsafe_ptr=__temp1647v__unsafe_ptr;
  buf__unsafe_size=__temp1647v__unsafe_size;
  buf__unsafe_align=__temp1647v__unsafe_align;
  __temp1648v=0;
  __temp1649v=__temp1648v;
  __temp_errcode=str__temp534v(__temp1650v,&__temp1651v__buf__unsafe_ptr,&__temp1651v__buf__unsafe_size,&__temp1651v__buf__unsafe_align,&__temp1651v__dat__pos,&__temp1651v__dat__length,&__temp1651v__dat__first);
  if(__temp_errcode){
  goto __temp_failure;
  }
  __temp_errcode=copy__temp650v(&buf__unsafe_ptr,&buf__unsafe_size,&buf__unsafe_align,&__temp1649v,__temp1651v__buf__unsafe_ptr,__temp1651v__buf__unsafe_size,__temp1651v__buf__unsafe_align,__temp1651v__dat__pos,__temp1651v__dat__length,__temp1651v__dat__first,&__temp1652v__buf__unsafe_ptr,&__temp1652v__buf__unsafe_size,&__temp1652v__buf__unsafe_align,&__temp1652v__dat__pos,&__temp1652v__dat__length,&__temp1652v__dat__first);
  if(__temp_errcode){
  goto __temp_failure;
  }
  s__buf__unsafe_ptr=__temp1652v__buf__unsafe_ptr;
  s__buf__unsafe_size=__temp1652v__buf__unsafe_size;
  s__buf__unsafe_align=__temp1652v__buf__unsafe_align;
  s__dat__pos=__temp1652v__dat__pos;
  s__dat__length=__temp1652v__dat__length;
  s__dat__first=__temp1652v__dat__first;
  __temp_errcode=system__temp1294v(s__buf__unsafe_ptr,s__buf__unsafe_size,s__buf__unsafe_align,s__dat__pos,s__dat__length,s__dat__first);
  if(__temp_errcode){
  goto __temp_failure;
  }
  
  __temp_failure:__temp1754v=0;
  neq__temp302v(__temp1645v__unsafe_size,__temp1754v,&__temp1755v);
  if(__temp1755v){
