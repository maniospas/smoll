...
static inline __attribute__((always_inline)) void eq__t1075t(const char* x, const char* y, char* __t2016t) {
  char z=0;
  z=(x==y);
  goto __t_return;
  __t_return:
...
static inline __attribute__((always_inline)) void main__t2011t() {
  char __t2014t__=0;
  console__t366t();
  eq__t1075t(__t2013t,__t2013t,&__t2014t__);
  print__t397t(__t2014t__);
}
