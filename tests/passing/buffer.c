...
static inline __attribute__((always_inline)) void is_different__temp69v(uint64_t x, uint64_t y, int* __temp1259v) {
  int __temp70v=0;
  int __temp71v__=0;
  not__temp35v(__temp70v,&__temp71v__);
  goto __temp_return;
  __temp_return:
  *__temp1259v=__temp71v__;
}

static inline __attribute__((always_inline)) void eq__temp96v(uint64_t x, uint64_t y, char* __temp1260v) {
  int __temp97v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void neq__temp120v(uint64_t x, uint64_t y, char* __temp1261v) {
  int __temp121v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void mul__temp172v(uint64_t x, uint64_t y, uint64_t* __temp1262v) {
  int __temp173v__=0;
  uint64_t z=0;
...
static inline __attribute__((always_inline)) void ge__temp297v(uint64_t x, uint64_t y, char* __temp1270v) {
  int __temp298v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void lt__temp225v(uint64_t x, uint64_t y, char* __temp1281v) {
  int __temp226v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) int sub__temp321v(uint64_t x, uint64_t y, uint64_t* __temp1288v) {
  int __temp322v__=0;
  int __temp323v=0;
  int __temp324v=0;
  char __temp325v__=0;
...
static inline __attribute__((always_inline)) int mutlast__temp522v(char** __temp1289v, uint64_t* __temp1290v, uint64_t* __temp1291v, char** __temp1292v) {
  ...
  int __temp_complain=0;
  __temp523v=0;
  eq__temp96v(__temp523v,buffer__unsafe_size,&__temp524v__);
  if(__temp524v__){
  __temp_errcode=12;
  goto __temp_failure;
  }
  __temp525v=1;
  __temp_errcode=sub__temp321v(buffer__unsafe_size,__temp525v,&__temp526v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
  mul__temp172v(__temp526v__,buffer__unsafe_align,&__temp527v__);
...
static inline __attribute__((always_inline)) void is_different__temp93v(double x, double y, int* __temp1297v) {
  int __temp94v=0;
  int __temp95v__=0;
  not__temp35v(__temp94v,&__temp95v__);
  goto __temp_return;
  __temp_return:
  *__temp1297v=__temp95v__;
}

static inline __attribute__((always_inline)) void add__temp170v(double x, double y, double* __temp1298v) {
  int __temp171v__=0;
  double z=0;
...
static inline __attribute__((always_inline)) int main__temp1240v() {
  ...
  add__temp170v(__temp1246v__z,__temp1249v__z,&__temp1250v__);
  print__temp366v(__temp1250v__);
