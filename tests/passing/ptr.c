...
static inline __attribute__((always_inline)) void is_different__temp93v(uint64_t x, uint64_t y, int* __temp1287v) {
  int __temp94v=0;
  int __temp95v__=0;
  not__temp35v(__temp94v,&__temp95v__);
  goto __temp_return;
  __temp_return:
  *__temp1287v=__temp95v__;
}

static inline __attribute__((always_inline)) void eq__temp118v(uint64_t x, uint64_t y, char* __temp1288v) {
  int __temp119v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void neq__temp142v(uint64_t x, uint64_t y, char* __temp1289v) {
  int __temp143v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) int sub__temp347v(uint64_t x, uint64_t y, uint64_t* __temp1314v) {
  int __temp348v__=0;
  int __temp349v=0;
  int __temp350v=0;
  char __temp351v__=0;
...
static inline __attribute__((always_inline)) int print__temp1224v(char* f) {
  ...
  print__temp366v(__temp1225v__a__x,__temp1226v);
  if(!f){
  __temp_errcode=2;
  goto __temp_failure;
  }
  ...
  print__temp366v(__temp1228v__a__y,__temp1226v);
  if(!f){
  __temp_errcode=2;
  goto __temp_failure;
  }
  ...
  print__temp366v(__temp1230v__b__x,__temp1226v);
  if(!f){
  __temp_errcode=2;
  goto __temp_failure;
  }
  ...
  print__temp368v(__temp1232v__b__y);
...
static inline __attribute__((always_inline)) int main__temp1234v() {
  ...
  double __temp1247v__value=0;
  uint64_t __temp1249v=0;
  char* __temp1250v__=0;
  char* f0=0;
  double __temp1251v__value=0;
  ...
  memcpy(&__temp1247v__value,__temp1246v__,8);
  print__temp368v(__temp1247v__value);
  __temp1249v=0;
  ...
  memcpy(&__temp1251v__value,f0,8);
  __temp1252v=2;
  ...
  memcpy(__temp1254v__,&__temp1251v__value,8);
  ...
  memcpy(&__temp1278v__value,n,8);
  print__temp368v(__temp1278v__value);
