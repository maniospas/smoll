...
int add__temp1362v(char** __temp1771v, uint64_t* __temp1772v, uint64_t* __temp1773v, uint64_t* __temp1774v, uint64_t allocator__length, char* v1__unsafe_ptr, uint64_t v1__pos, uint64_t v1__length, char* v2__unsafe_ptr, uint64_t v2__pos, uint64_t v2__length, char** __temp1775v, uint64_t* __temp1776v, uint64_t* __temp1777v) {
  ...
  char* __temp1365v__unsafe_ptr=0;
  uint64_t __temp1365v__pos=0;
  uint64_t __temp1365v__length=0;
  char* v__unsafe_ptr=0;
  uint64_t v__pos=0;
  uint64_t v__length=0;
  uint64_t __temp1366v__from=0;
  uint64_t __temp1366v__to=0;
  uint64_t it__from=0;
  uint64_t it__to=0;
  char* p1=0;
  char __temp1367v=0;
  ...
  double __temp1371v__z=0;
  double __temp1372v__=0;
  double __temp1373v__=0;
  int __temp_errcode=0;
  int __temp_complain=0;
  neq__temp142v(v1__length,v2__length,&__temp1364v__);
  if(__temp1364v__){
  __temp_errcode=32;
  goto __temp_failure;
  }
  __temp_errcode=vec__temp1278v(&allocator__buf__unsafe_ptr,&allocator__buf__unsafe_size,&allocator__buf__unsafe_align,&allocator__pos,allocator__length,v1__length,&__temp1365v__unsafe_ptr,&__temp1365v__pos,&__temp1365v__length);
  if(__temp_errcode){
  goto __temp_failure;
  }
  v__unsafe_ptr=__temp1365v__unsafe_ptr;
  v__pos=__temp1365v__pos;
  v__length=__temp1365v__length;
  range__temp435v(v1__length,&__temp1366v__from,&__temp1366v__to);
  it__from=__temp1366v__from;
  it__to=__temp1366v__to;
  p1=v1__unsafe_ptr;
  while(1){
  __temp_complain=next__temp439v(&it__from,it__to,&__temp1368v__);
  __temp1367v=__temp_complain;
  i=__temp1368v__;
  __temp1367v=__temp1367v==0;
  if(!__temp1367v){
  break;
  }
  mutget__temp1289v(v__unsafe_ptr,v__pos,v__length,i,&__temp1369v__);
  get__temp1294v(v1__unsafe_ptr,v1__pos,v1__length,i,&__temp1370v__);
  if(!__temp1370v__){
  goto __temp_failure;
  }
  memcpy(&__temp1371v__z,__temp1370v__,8);
  __temp_errcode=at__temp1300v(v2__unsafe_ptr,v2__pos,v2__length,i,&__temp1372v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
  add__temp148v(__temp1371v__z,__temp1372v__,&__temp1373v__);
  if(!__temp1369v__){
  goto __temp_failure;
  }
  memcpy(__temp1369v__,&__temp1373v__,8);
  }
  goto __temp_return;
...
static inline __attribute__((always_inline)) int mul__temp1528v(char** __temp1780v, uint64_t* __temp1781v, uint64_t* __temp1782v, uint64_t* __temp1783v, uint64_t allocator__length, char* v1__unsafe_ptr, uint64_t v1__pos, uint64_t v1__length, double v2, char** __temp1784v, uint64_t* __temp1785v, uint64_t* __temp1786v) {
  ...
  int __temp1529v=0;
  char* __temp1530v__unsafe_ptr=0;
  uint64_t __temp1530v__pos=0;
  uint64_t __temp1530v__length=0;
  char* v__unsafe_ptr=0;
  uint64_t v__pos=0;
  uint64_t v__length=0;
  uint64_t __temp1531v__from=0;
  uint64_t __temp1531v__to=0;
  uint64_t it__from=0;
  uint64_t it__to=0;
  char __temp1532v=0;
  ...
  double __temp1536v__z=0;
  double __temp1537v__=0;
  double __temp1538v__=0;
  int __temp_errcode=0;
  int __temp_complain=0;
  __temp_errcode=vec__temp1278v(&allocator__buf__unsafe_ptr,&allocator__buf__unsafe_size,&allocator__buf__unsafe_align,&allocator__pos,allocator__length,v1__length,&__temp1530v__unsafe_ptr,&__temp1530v__pos,&__temp1530v__length);
  if(__temp_errcode){
  goto __temp_failure;
  }
  v__unsafe_ptr=__temp1530v__unsafe_ptr;
  v__pos=__temp1530v__pos;
  v__length=__temp1530v__length;
  range__temp435v(v1__length,&__temp1531v__from,&__temp1531v__to);
  it__from=__temp1531v__from;
  it__to=__temp1531v__to;
  while(1){
  __temp_complain=next__temp439v(&it__from,it__to,&__temp1533v__);
  __temp1532v=__temp_complain;
  i=__temp1533v__;
  __temp1532v=__temp1532v==0;
  if(!__temp1532v){
  break;
  }
  mutget__temp1289v(v__unsafe_ptr,v__pos,v__length,i,&__temp1534v__);
  get__temp1294v(v1__unsafe_ptr,v1__pos,v1__length,i,&__temp1535v__);
  if(!__temp1535v__){
  goto __temp_failure;
  }
  memcpy(&__temp1536v__z,__temp1535v__,8);
  at__temp1299v(v2,i,&__temp1537v__);
  mul__temp172v(__temp1536v__z,__temp1537v__,&__temp1538v__);
  if(!__temp1534v__){
  goto __temp_failure;
  }
  memcpy(__temp1534v__,&__temp1538v__,8);
  }
  goto __temp_return;
...
static inline __attribute__((always_inline)) int mul__temp1556v(char** __temp1787v, uint64_t* __temp1788v, uint64_t* __temp1789v, uint64_t* __temp1790v, uint64_t allocator__length, double v1, char* v2__unsafe_ptr, uint64_t v2__pos, uint64_t v2__length, char** __temp1791v, uint64_t* __temp1792v, uint64_t* __temp1793v) {
  ...
  int __temp_errcode=0;
  int __temp_complain=0;
  __temp_errcode=mul__temp1528v(&allocator__buf__unsafe_ptr,&allocator__buf__unsafe_size,&allocator__buf__unsafe_align,&allocator__pos,allocator__length,v2__unsafe_ptr,v2__pos,v2__length,v1,&__temp1557v__unsafe_ptr,&__temp1557v__pos,&__temp1557v__length);
  if(__temp_errcode){
  goto __temp_failure;
  }
  goto __temp_return;
...
static inline __attribute__((always_inline)) int safe_main__temp1657v() {
  ...
  __temp1691v=2.0;
  __temp_errcode=add__temp1362v(&__temp1659v__unsafe_ptr,&__temp1659v__unsafe_size,&__temp1659v__unsafe_align,&allocator__pos,allocator__length,v2__unsafe_ptr,v2__pos,v2__length,__temp1659v__unsafe_ptr,v__pos,v__length,&__temp1692v__unsafe_ptr,&__temp1692v__pos,&__temp1692v__length);
  if(__temp_errcode){
  goto __temp_failure;
  }
  __temp_errcode=add__temp1362v(&__temp1659v__unsafe_ptr,&__temp1659v__unsafe_size,&__temp1659v__unsafe_align,&allocator__pos,allocator__length,v1__unsafe_ptr,v1__pos,v1__length,__temp1659v__unsafe_ptr,__temp1692v__pos,__temp1692v__length,&__temp1693v__unsafe_ptr,&__temp1693v__pos,&__temp1693v__length);
  if(__temp_errcode){
  goto __temp_failure;
  }
