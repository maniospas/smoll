...
If you use an editor other than vscode, a Python syntax highlighter covers many language aspects and you can rely on
a mixture of comprehensive error messages and creating documentation with <pre class="skiptry">smoll main.s --docs</pre>
...
<br>&nbsp;• code completion recommendations for imports, variables, fields, and functions
...
Create a new folder. Place within it the executable matching your platform without changing its name. Alternatively,
add the executable to your system PATH. Then, open vscode or your editor of choice in that folder.
...
<br>
<br>
In <b>windows</b> install GCC by installing msys2 first and then run:
...
<details><summary><b>Compile with other backends, or for the web.</b></summary>
<br>
&nbsp;• <code>--back clang</code> Instead of gcc, use the equally popular clang compiler.
<br>
&nbsp;• <code>--back tcc</code> Incredibly fast but unoptimized compilation, use the *tcc* compiler.
<br>
&nbsp;• <code>--back antcc</code> A trade-off between fast yet reasonably optimized compilation with the exemplary 
<a href="https://codeberg.org/lsof/antcc">antcc</a> compiler for WSL or linux. 
This is faster than GCC with roughly comparable optimization speeds for smoλ code.
A fork of that compiler has been tailored to work well for us. Download
the precompiled executable (or compile it from scratch), and place it in your project directory.
<br>
&nbsp;• <code>--back emcc</code> Compile for the web using emcripten. Since this is typically used for
creating visual application, refer to the <a href="tutorial_game.html">➔ Game dev tutorial</a>.
<br>

<br><br>
<a href="https://releases.llvm.org/download.html" class="button">➔ clang download</a>
<a href="https://tinycc-tinycc.mintlify.app/installation" class="button">➔ tcc installation</a>
