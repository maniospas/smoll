...
static inline int alloc__temp382v(unsigned long long bytes__value, void** __temp459v) {
  void* allocated=0;
  int failed=0;
...
static inline int alloc__temp391v(void** __temp460v, unsigned long long* __temp461v, unsigned long long* __temp462v, unsigned long long size__value, void** __temp463v, unsigned long long* __temp464v, unsigned long long* __temp465v) {
...
static inline void add__temp387v(void* allocated, unsigned long long offset__value, void** __temp468v) {
  void* element=0;
...
static inline int mutget__temp420v(void** __temp469v, unsigned long long* __temp470v, unsigned long long* __temp471v, unsigned long long i__value, void** __temp472v) {
...
static inline int get__temp424v(void* buffer__unsafe_ptr, unsigned long long buffer__unsafe_size, unsigned long long buffer__unsafe_align, unsigned long long i__value, void** __temp478v) {
  int __temp425v__z=0;
...
static inline int main__temp434v() {
  ...
  print__temp335v(__temp448v__plane__x);
  return 0;
  __temp_failure:
  return __temp_errcode;
}
