...
int temporary_cstr__t712t(char* other__unsafe_ptr, uint64_t other__dat__pos, uint64_t other__dat__length, char other__dat__first, const char** __t1896t, char** __t1897t, uint64_t* __t1898t, uint64_t* __t1899t, char* __t1900t) {
