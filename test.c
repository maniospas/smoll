...
static inline void alloc__temp367v(unsigned long long bytes, void** __temp503v) {
  void* allocated=0;
...
static inline void realloc__temp368v(void* allocated, unsigned long long bytes, void** __temp515v) {
...
static inline void resize__temp387v(void** __temp517v, unsigned long long* __temp518v, unsigned long long buffer__align, unsigned long long size, void** __temp519v, unsigned long long* __temp520v, unsigned long long* __temp521v) {
...
static inline int print__temp442v(void* f) {
  double __temp443v__a__x=0;
  double __temp443v__a__y=0;
  double __temp443v__b__x=0;
  double __temp443v__b__y=0;
  const char* __temp444v=0;
  double __temp446v__a__x=0;
  double __temp446v__a__y=0;
  double __temp446v__b__x=0;
  double __temp446v__b__y=0;
  const char* __temp447v=0;
  double __temp449v__a__x=0;
  double __temp449v__a__y=0;
  double __temp449v__b__x=0;
  double __temp449v__b__y=0;
  const char* __temp450v=0;
  double __temp452v__a__x=0;
  double __temp452v__a__y=0;
  double __temp452v__b__x=0;
  double __temp452v__b__y=0;
  int __temp_errcode=0;
  if(!f){
  goto __temp_failure;
  }
  memcpy(&__temp443v__a__x,(char*)f,8);
  if(!f){
  goto __temp_failure;
  }
  memcpy(&__temp443v__a__y,(char*)f+8,8);
  if(!f){
  goto __temp_failure;
  }
  memcpy(&__temp443v__b__x,(char*)f+16,8);
  if(!f){
  goto __temp_failure;
  }
  memcpy(&__temp443v__b__y,(char*)f+24,8);
  __temp444v=",";
  print__temp335v(__temp443v__a__x,__temp444v);
  if(!f){
  goto __temp_failure;
  }
  memcpy(&__temp446v__a__x,(char*)f,8);
  if(!f){
  goto __temp_failure;
  }
  memcpy(&__temp446v__a__y,(char*)f+8,8);
  if(!f){
  goto __temp_failure;
  }
  memcpy(&__temp446v__b__x,(char*)f+16,8);
  if(!f){
  goto __temp_failure;
  }
  memcpy(&__temp446v__b__y,(char*)f+24,8);
  __temp447v=",";
  print__temp335v(__temp446v__a__y,__temp447v);
  if(!f){
  goto __temp_failure;
  }
  memcpy(&__temp449v__a__x,(char*)f,8);
  if(!f){
  goto __temp_failure;
  }
  memcpy(&__temp449v__a__y,(char*)f+8,8);
  if(!f){
  goto __temp_failure;
  }
  memcpy(&__temp449v__b__x,(char*)f+16,8);
  if(!f){
  goto __temp_failure;
  }
  memcpy(&__temp449v__b__y,(char*)f+24,8);
  __temp450v=",";
  print__temp335v(__temp449v__b__x,__temp450v);
  if(!f){
  goto __temp_failure;
  }
  memcpy(&__temp452v__a__x,(char*)f,8);
  if(!f){
  goto __temp_failure;
  }
  memcpy(&__temp452v__a__y,(char*)f+8,8);
  if(!f){
  goto __temp_failure;
  }
  memcpy(&__temp452v__b__x,(char*)f+16,8);
  if(!f){
  goto __temp_failure;
  }
  memcpy(&__temp452v__b__y,(char*)f+24,8);
  print__temp337v(__temp452v__b__y);
  return 0;
  __temp_failure:
  return __temp_errcode;
}
...
static inline int main__temp454v() {
  ...
  memcpy(&__temp465v__value,(char*)__temp464v____temp408v____temp373v__to,8);
  print__temp337v(__temp465v__value);
  __temp467v=0;
  ...
  memcpy(&__temp469v__value,(char*)f0,8);
  __temp470v=2;
  resize__temp387v(&f__unsafe_ptr,&f__unsafe_size,f__align,__temp470v,&__temp471v__buffer__unsafe_ptr,&__temp471v__buffer__unsafe_size,&__temp471v__buffer__align);
  ...
  memcpy((char*)__temp472v____temp404v____temp373v__to,&__temp469v__value,8);
  ...
  memcpy(&__temp492v__value,(char*)n,8);
  print__temp337v(__temp492v__value);
  return 0;
  __temp_failure:
  return __temp_errcode;
}
