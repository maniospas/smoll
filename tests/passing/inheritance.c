...
static inline __attribute__((always_inline)) void is_different__temp69v(uint64_t x, uint64_t y, int* __temp1285v) {
  int __temp70v=0;
  int __temp71v__=0;
  not__temp35v(__temp70v,&__temp71v__);
  goto __temp_return;
  __temp_return:
  *__temp1285v=__temp71v__;
}

static inline __attribute__((always_inline)) void eq__temp96v(uint64_t x, uint64_t y, char* __temp1286v) {
  int __temp97v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void neq__temp120v(uint64_t x, uint64_t y, char* __temp1287v) {
  int __temp121v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void mul__temp172v(uint64_t x, uint64_t y, uint64_t* __temp1288v) {
  int __temp173v__=0;
  uint64_t z=0;
...
static inline __attribute__((always_inline)) void ge__temp297v(uint64_t x, uint64_t y, char* __temp1296v) {
  int __temp298v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void lt__temp225v(uint64_t x, uint64_t y, char* __temp1309v) {
  int __temp226v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void is_different__temp93v(double x, double y, int* __temp1311v) {
  int __temp94v=0;
  int __temp95v__=0;
...
static inline __attribute__((always_inline)) void add__temp170v(double x, double y, double* __temp1312v) {
  int __temp171v__=0;
  double z=0;
...
static inline __attribute__((always_inline)) void add__temp148v(uint64_t x, uint64_t y, uint64_t* __temp1313v) {
  int __temp149v__=0;
  uint64_t z=0;
...
static inline __attribute__((always_inline)) int sum__temp1225v(char** __temp1314v, uint64_t* __temp1315v, uint64_t* __temp1316v, double* __temp1317v, double* __temp1318v) {
  ...
  lt__temp225v(i,__temp1232v__,&__temp1233v__);
  if(!__temp1233v__){
  break;
  }
  ...
  add__temp170v(x,__temp1235v__x,&__temp1236v__);
  x=__temp1236v__;
  ...
  add__temp170v(y,__temp1238v__y,&__temp1239v__);
  y=__temp1239v__;
  __temp1240v=1;
  add__temp148v(i,__temp1240v,&__temp1241v__);
  i=__temp1241v__;
  }
  goto __temp_return;
