...
static inline __attribute__((always_inline)) void Point3D____temp_buffer____buffer__temp1272v(char** __temp1304v, uint64_t* __temp1305v, uint16_t* __temp1306v, uint16_t* __temp1307v) {
  char* unsafe_ptr=0;
...
static inline __attribute__((always_inline)) int mutget__temp543v(char** __temp1331v, uint64_t* __temp1332v, uint16_t* __temp1333v, uint16_t* __temp1334v, uint64_t i, char** __temp1335v) {
  ...
  *__temp1335v=__temp549v__;
  
  return __temp_errcode;
}

static inline __attribute__((always_inline)) void Point2D__temp1248v(double x, double y, double* __temp1336v, double* __temp1337v) {
  goto __temp_return;
  __temp_return:
  *__temp1336v=x;
  *__temp1337v=y;
...
static inline __attribute__((always_inline)) void Point3D__temp1268v(double x, double y, double z, double* __temp1338v, double* __temp1339v, double* __temp1340v) {
  double __temp1269v__x=0;
  double __temp1269v__y=0;
  double plane__x=0;
  double plane__y=0;
  Point2D__temp1248v(x,y,&__temp1269v__x,&__temp1269v__y);
  plane__x=__temp1269v__x;
  plane__y=__temp1269v__y;
  goto __temp_return;
  __temp_return:
  *__temp1338v=plane__x;
  *__temp1339v=plane__y;
  *__temp1340v=z;
}

static inline __attribute__((always_inline)) void len__temp557v(char* buffer__unsafe_ptr, uint64_t buffer__unsafe_size, uint16_t buffer__unsafe_offset, uint16_t buffer__unsafe_align, uint64_t* __temp1341v) {
  goto __temp_return;
  __temp_return:
  *__temp1341v=buffer__unsafe_size;
}

static inline __attribute__((always_inline)) void lt__temp247v(uint64_t x, uint64_t y, char* __temp1342v) {
  int __temp248v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) int get__temp550v(char* buffer__unsafe_ptr, uint64_t buffer__unsafe_size, uint16_t buffer__unsafe_offset, uint16_t buffer__unsafe_align, uint64_t i, char** __temp1343v) {
  char __temp551v__=0;
  ...
  __temp_failure:__temp_return:
  *__temp1343v=__temp556v__;
  
  return __temp_errcode;
}

static inline __attribute__((always_inline)) void is_different__temp69v(double x, double y, int* __temp1344v) {
  int __temp70v=0;
  int __temp71v__=0;
  not__temp35v(__temp70v,&__temp71v__);
  goto __temp_return;
  __temp_return:
  *__temp1344v=__temp71v__;
}

static inline __attribute__((always_inline)) void add__temp148v(double x, double y, double* __temp1345v) {
  int __temp149v__=0;
  double z=0;
...
static inline __attribute__((always_inline)) int sum__temp1251v(char** __temp1346v, uint64_t* __temp1347v, uint16_t* __temp1348v, uint16_t* __temp1349v, double* __temp1350v, double* __temp1351v) {
  char* v__unsafe_ptr=*__temp1346v;
  uint64_t v__unsafe_size=*__temp1347v;
  uint16_t v__unsafe_offset=*__temp1348v;
  uint16_t v__unsafe_align=*__temp1349v;
  ...
  lt__temp247v(i,__temp1258v__,&__temp1259v__);
  if(!__temp1259v__){
  break;
  }
  ...
  y=__temp1265v__;
  __temp1266v=1;
  add__temp170v(i,__temp1266v,&__temp1267v__);
  i=__temp1267v__;
  }
  goto __temp_return;
  
  __temp_failure:__temp_return:
  *__temp1346v=v__unsafe_ptr;
  *__temp1347v=v__unsafe_size;
  *__temp1348v=v__unsafe_offset;
  *__temp1349v=v__unsafe_align;
  *__temp1350v=x;
  *__temp1351v=y;
...
static inline __attribute__((always_inline)) int main__temp1271v() {
  ...
  double __temp1287v__plane__x=0;
  double __temp1287v__plane__y=0;
  double __temp1287v__z=0;
  ...
  double __temp1296v__plane__x=0;
  double __temp1296v__plane__y=0;
  double __temp1296v__z=0;
  ...
  double __temp1301v__x=0;
  double __temp1301v__y=0;
  double sums__x=0;
  double sums__y=0;
  int __temp_errcode=0;
  int __temp_complain=0;
  ...
  Point3D__temp1268v(__temp1282v,__temp1284v,__temp1286v,&__temp1287v__plane__x,&__temp1287v__plane__y,&__temp1287v__z);
  if(!__temp1280v__){
  __temp_errcode=2;
  goto __temp_failure;
  }
  memcpy(__temp1280v__,&__temp1287v__plane__x,8);
  memcpy(__temp1280v__+8,&__temp1287v__plane__y,8);
  memcpy(__temp1280v__+16,&__temp1287v__z,8);
  __temp1288v=1;
  __temp_errcode=mutget__temp543v(&points__unsafe_ptr,&points__unsafe_size,&points__unsafe_offset,&points__unsafe_align,__temp1288v,&__temp1289v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
  __temp1290v=1.0;
  ...
  Point3D__temp1268v(__temp1291v,__temp1293v,__temp1295v,&__temp1296v__plane__x,&__temp1296v__plane__y,&__temp1296v__z);
  if(!__temp1289v__){
  __temp_errcode=2;
  goto __temp_failure;
  }
  memcpy(__temp1289v__,&__temp1296v__plane__x,8);
  memcpy(__temp1289v__+8,&__temp1296v__plane__y,8);
  memcpy(__temp1289v__+16,&__temp1296v__z,8);
  __temp1297v__unsafe_ptr=points__unsafe_ptr;
  __temp1297v__unsafe_size=points__unsafe_size;
  __temp1297v__unsafe_offset=points__unsafe_offset+0;
  __temp1297v__unsafe_align=points__unsafe_align;
  __temp_errcode=sum__temp1251v(&__temp1297v__unsafe_ptr,&__temp1297v__unsafe_size,&__temp1297v__unsafe_offset,&__temp1297v__unsafe_align,&__temp1301v__x,&__temp1301v__y);
  if(__temp_errcode){
  goto __temp_failure;
  }
  sums__x=__temp1301v__x;
  sums__y=__temp1301v__y;
