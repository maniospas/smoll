...
int fib__temp1250v(uint64_t n, uint64_t* __temp1276v) ;
...
int fib__temp1250v(uint64_t n, uint64_t* __temp1276v) {
  ...
  __temp_errcode=fib__temp1250v(__temp1263v__,&__temp1264v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
  __temp1265v=2;
  ...
  __temp_errcode=fib__temp1250v(__temp1266v__,&__temp1267v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
...
static inline __attribute__((always_inline)) int main__temp1254v() {
  ...
  int __temp_complain=0;
  __temp1255v=10;
  __temp_errcode=fib__temp1250v(__temp1255v,&__temp1256v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
