...
```rust
get(console CLI, url) -> (str) with effects CLI
```
Potential errors:
...
```rust
get(console CLI, url, cstr path) -> (str) with effects CLI
```
Potential errors:
...
```rust
get(console CLI, url, str) -> (str) with effects CLI
```
Potential errors:
...
```rust
str(char[] {element size 1}, nat pos, "to", nat length) -> (str)
```
Potential errors:
