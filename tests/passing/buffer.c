...
static inline __attribute__((always_inline)) void float__temp_buffer__buffer__temp1221v(char** __temp1250v, uint64_t* __temp1251v, uint64_t* __temp1252v) {
  char* unsafe_ptr=0;
...
static inline __attribute__((always_inline)) void exists__temp412v(char* x, char* __temp1253v) {
  char z=0;
  z=x!=0;
  goto __temp_return;
  __temp_return:
...
static inline __attribute__((always_inline)) void free__temp461v(char** __temp1254v) {
  char* allocated=*__temp1254v;
  if(allocated){
  free(allocated);
  }
  allocated=0;
...
static inline __attribute__((always_inline)) void false__temp10v(int* __temp1255v) {
  int value=0;
  *__temp1255v=value;
}

static inline __attribute__((always_inline)) void not__temp35v(int __temp_anon0, int* __temp1256v) {
  int __temp36v__=0;
  false__temp10v(&__temp36v__);
  goto __temp_return;
  __temp_return:
  *__temp1256v=__temp36v__;
}

static inline __attribute__((always_inline)) void is_different__temp93v(uint64_t x, uint64_t y, int* __temp1257v) {
  int __temp94v=0;
  int __temp95v__=0;
  not__temp35v(__temp94v,&__temp95v__);
  goto __temp_return;
  __temp_return:
  *__temp1257v=__temp95v__;
}

static inline __attribute__((always_inline)) void eq__temp118v(uint64_t x, uint64_t y, char* __temp1258v) {
  int __temp119v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void neq__temp142v(uint64_t x, uint64_t y, char* __temp1259v) {
  int __temp143v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void mul__temp194v(uint64_t x, uint64_t y, uint64_t* __temp1260v) {
  int __temp195v__=0;
  uint64_t z=0;
...
static inline __attribute__((always_inline)) int alloc__temp458v(uint64_t bytes, char** __temp1261v) {
  char* unsafe_ptr=0;
  char failed=0;
...
static inline __attribute__((always_inline)) int alloc__temp467v(char** __temp1262v, uint64_t* __temp1263v, uint64_t* __temp1264v, uint64_t size, char** __temp1265v, uint64_t* __temp1266v, uint64_t* __temp1267v) {
...
static inline __attribute__((always_inline)) void ge__temp319v(uint64_t x, uint64_t y, char* __temp1268v) {
  int __temp320v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void attach_type__temp20v(char* to, char* from, char** __temp1269v) {
  *__temp1269v=to;
}

static inline __attribute__((always_inline)) void add__temp463v(char* allocated, uint64_t offset, char** __temp1270v) {
  char* element=0;
  char* __temp464v__=0;
  ...
  goto __temp_return;
  __temp_return:
  *__temp1270v=__temp464v__;
}

static inline __attribute__((always_inline)) int mutget__temp529v(char** __temp1271v, uint64_t* __temp1272v, uint64_t* __temp1273v, uint64_t i, char** __temp1274v) {
  ...
  *__temp1274v=__temp532v__;
  
  return __temp_errcode;
}

static inline __attribute__((always_inline)) int test1__temp1220v(char** __temp1275v, uint64_t* __temp1276v, uint64_t* __temp1277v) {
  ...
  float__temp_buffer__buffer__temp1221v(&__temp1231v__unsafe_ptr,&__temp1231v__unsafe_size,&__temp1231v__unsafe_align);
  y__unsafe_ptr=__temp1231v__unsafe_ptr;
  y__unsafe_size=__temp1231v__unsafe_size;
  y__unsafe_align=__temp1231v__unsafe_align;
  goto __temp_return;
  
  __temp_failure:exists__temp412v(x__unsafe_ptr,&__temp1227v____temp469v__);
...
static inline __attribute__((always_inline)) int realloc__temp459v(char* allocated__unsafe_ptr, uint64_t bytes, char** __temp1278v) {
  ...
  __temp_failure:__temp_return:
  *__temp1278v=__temp460v__;
  
  return __temp_errcode;
}

static inline __attribute__((always_inline)) void lt__temp247v(uint64_t x, uint64_t y, char* __temp1279v) {
  int __temp248v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) int resize__temp502v(char** __temp1280v, uint64_t* __temp1281v, uint64_t* __temp1282v, uint64_t size, char** __temp1283v, uint64_t* __temp1284v, uint64_t* __temp1285v) {
...
static inline __attribute__((always_inline)) int sub__temp347v(uint64_t x, uint64_t y, uint64_t* __temp1286v) {
  int __temp348v__=0;
  int __temp349v=0;
  int __temp350v=0;
  char __temp351v__=0;
...
static inline __attribute__((always_inline)) int mutlast__temp522v(char** __temp1287v, uint64_t* __temp1288v, uint64_t* __temp1289v, char** __temp1290v) {
  ...
  *__temp1290v=__temp528v__;
  
  return __temp_errcode;
}

static inline __attribute__((always_inline)) int test2__temp1232v(char** __temp1291v, uint64_t* __temp1292v, uint64_t* __temp1293v) {
  char* x__unsafe_ptr=*__temp1291v;
  uint64_t x__unsafe_size=*__temp1292v;
  uint64_t x__unsafe_align=*__temp1293v;
  ...
  int __temp_complain=0;
  __temp1233v=2;
  __temp_errcode=resize__temp502v(&x__unsafe_ptr,&x__unsafe_size,&x__unsafe_align,__temp1233v,&__temp1234v__unsafe_ptr,&__temp1234v__unsafe_size,&__temp1234v__unsafe_align);
  if(__temp_errcode){
  goto __temp_failure;
  }
  __temp_errcode=mutlast__temp522v(&__temp1234v__unsafe_ptr,&__temp1234v__unsafe_size,&__temp1234v__unsafe_align,&__temp1235v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
  __temp1236v=2.0;
  ...
  memcpy(__temp1235v__,&__temp1236v,8);
  __temp1237v=__temp1235v__;
  
  __temp_failure:*__temp1291v=x__unsafe_ptr;
  *__temp1292v=x__unsafe_size;
  *__temp1293v=x__unsafe_align;
  
  return __temp_errcode;
}

static inline __attribute__((always_inline)) int get__temp533v(char* buffer__unsafe_ptr, uint64_t buffer__unsafe_size, uint64_t buffer__unsafe_align, uint64_t i, char** __temp1294v) {
  char __temp534v__=0;
  ...
  __temp_failure:__temp_return:
  *__temp1294v=__temp536v__;
  
  return __temp_errcode;
}

static inline __attribute__((always_inline)) void is_different__temp69v(double x, double y, int* __temp1295v) {
  int __temp70v=0;
  int __temp71v__=0;
  not__temp35v(__temp70v,&__temp71v__);
  goto __temp_return;
  __temp_return:
  *__temp1295v=__temp71v__;
}

static inline __attribute__((always_inline)) void add__temp148v(double x, double y, double* __temp1296v) {
  int __temp149v__=0;
  double z=0;
...
static inline __attribute__((always_inline)) int main__temp1238v() {
  ...
  char __temp1240v____temp1227v____temp469v__=0;
  char* x__unsafe_ptr=0;
  uint64_t x__unsafe_size=0;
  uint64_t x__unsafe_align=0;
  uint64_t __temp1242v=0;
  char* __temp1243v__=0;
  double __temp1244v__number=0;
  uint64_t __temp1245v=0;
  char* __temp1246v__=0;
  double __temp1247v__number=0;
  double __temp1248v__=0;
  int __temp_errcode=0;
  int __temp_complain=0;
  __temp_errcode=test1__temp1220v(&__temp1239v__unsafe_ptr,&__temp1239v__unsafe_size,&__temp1239v__unsafe_align);
  if(__temp_errcode){
  goto __temp_failure;
  }
  x__unsafe_ptr=__temp1239v__unsafe_ptr;
  x__unsafe_size=__temp1239v__unsafe_size;
  x__unsafe_align=__temp1239v__unsafe_align;
  __temp_errcode=test2__temp1232v(&x__unsafe_ptr,&x__unsafe_size,&x__unsafe_align);
  if(__temp_errcode){
  goto __temp_failure;
  }
  __temp1242v=0;
  __temp_errcode=get__temp533v(x__unsafe_ptr,x__unsafe_size,x__unsafe_align,__temp1242v,&__temp1243v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
  if(!__temp1243v__){
  ...
  memcpy(&__temp1244v__number,__temp1243v__,8);
  __temp1245v=1;
  __temp_errcode=get__temp533v(x__unsafe_ptr,x__unsafe_size,x__unsafe_align,__temp1245v,&__temp1246v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
  if(!__temp1246v__){
  ...
  memcpy(&__temp1247v__number,__temp1246v__,8);
  add__temp148v(__temp1244v__number,__temp1247v__number,&__temp1248v__);
  print__temp366v(__temp1248v__);
  
  __temp_failure:exists__temp412v(__temp1239v__unsafe_ptr,&__temp1240v____temp1227v____temp469v__);
  if(__temp1240v____temp1227v____temp469v__){
  __temp1239v__unsafe_size=0;
  __temp1239v__unsafe_size=__temp1239v__unsafe_size;
  free__temp461v(&__temp1239v__unsafe_ptr);
  }
