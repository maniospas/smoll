...
int __t_argc;
char** __t_argv;
const char* const __t1571t="hello world!";
const char* const __t1576t="... and goodbye for now.";
...
static inline __attribute__((always_inline)) void range__t468t(uint64_t _from, uint64_t to, uint64_t* __t1582t, uint64_t* __t1583t) {
  uint64_t __t469t=0;
  uint64_t from=0;
  __t469t=_from;
  from=__t469t;
...
static inline __attribute__((always_inline)) void range__t471t(uint64_t to, uint64_t* __t1584t, uint64_t* __t1585t) {
  uint64_t __t472t=0;
  ...
  goto __t_return;
  __t_return:
  *__t1584t=__t473t__from;
  *__t1585t=__t473t__to;
}
...
static inline __attribute__((always_inline)) void ge__t324t(uint64_t x, uint64_t y, char* __t1589t) {
  int __t325t__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void lt__t252t(uint64_t x, uint64_t y, char* __t1590t) {
  int __t253t__=0;
  char z=0;
...
static inline __attribute__((always_inline)) int get__t478t(uint64_t r__from, uint64_t r__to, uint64_t pos, uint64_t* __t1591t) {
  char __t479t__=0;
  char __t480t__=0;
  int __t_errcode=0;
  int __t_complain=0;
...
static inline __attribute__((always_inline)) void cstr____buffer__t1574t(char** __t1592t, uint64_t* __t1593t, uint16_t* __t1594t, uint16_t* __t1595t) {
  char* unsafe_ptr=0;
  ...
  unsafe_align=8;
  *__t1592t=unsafe_ptr;
  *__t1593t=unsafe_size;
  *__t1594t=unsafe_offset;
  *__t1595t=unsafe_align;
}

static inline __attribute__((always_inline)) void exists__t447t(char* x, char* __t1596t) {
  char z=0;
  z=x!=0;
  goto __t_return;
  __t_return:
...
static inline __attribute__((always_inline)) void free__t503t(char** __t1597t) {
  char* allocated=*__t1597t;
  if(allocated){
  free(allocated);
  }
  *__t1597t=allocated;
...
static inline __attribute__((always_inline)) void add__t505t(char* allocated, uint64_t offset, char** __t1614t) {
  char* element=0;
  char* __t506t__=0;
...
static inline __attribute__((always_inline)) int get__t640t(char* buffer__unsafe_ptr, uint64_t buffer__unsafe_size, uint16_t buffer__unsafe_offset, uint16_t buffer__unsafe_align, uint64_t i, char** __t1615t) {
  char __t641t__=0;
...
static inline __attribute__((always_inline)) void print__t1557t(char* sentences__unsafe_ptr, uint64_t sentences__unsafe_size, uint16_t sentences__unsafe_offset, uint16_t sentences__unsafe_align) {
  uint64_t __t1558t=0;
  char __t1559t=0;
  char* __t1560t__=0;
  const char* __t1561t__value=0;
  const char* sentence=0;
  int __t_complain=0;
  __t1558t=0;
  while(1){
  __t_complain=get__t640t(sentences__unsafe_ptr,sentences__unsafe_size,sentences__unsafe_offset,sentences__unsafe_align,__t1558t,&__t1560t__);
  __t1559t=__t_complain;
  if(!__t1560t__){
  __t_complain=2;
  }
  else{
  memcpy(&__t1561t__value,__t1560t__,8);
  }
  sentence=__t1561t__value;
  __t1559t=__t1559t==0;
  __t1558t=__t1558t+1;
  if(!__t1559t){
  break;
...
static inline __attribute__((always_inline)) int main__t1563t() {
  ...
  console__t366t();
  __t1566t=10;
  range__t471t(__t1566t,&__t1567t__from,&__t1567t__to);
  __t1565t=0;
  while(1){
  __t_complain=get__t478t(__t1567t__from,__t1567t__to,__t1565t,&__t1569t__);
  ...
  cstr____buffer__t1574t(&__t1577t__unsafe_ptr,&__t1577t__unsafe_size,&__t1577t__unsafe_offset,&__t1577t__unsafe_align);
  __t1578t=2;
  ...
  memcpy(__t1577t__unsafe_ptr,&__t1571t,8);
  memcpy(__t1577t__unsafe_ptr+8,&__t1576t,8);
  print__t1557t(__t1577t__unsafe_ptr,__t1577t__unsafe_size,__t1577t__unsafe_offset,__t1577t__unsafe_align);
  
  __t_failure:
  goto __t_skip_returns;
  __t_skip_returns:exists__t447t(__t1579t__unsafe_ptr,&__t1580t____t534t__);
  if(__t1580t____t534t__){
  free__t503t(&__t1579t__unsafe_ptr);
  }
