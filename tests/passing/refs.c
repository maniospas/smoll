...
static inline __attribute__((always_inline)) void false__temp10v(int* __temp1225v) {
  int value=0;
  *__temp1225v=value;
}

static inline __attribute__((always_inline)) void not__temp34v(int __temp_anon0, int* __temp1226v) {
  int __temp35v__=0;
  false__temp10v(&__temp35v__);
  goto __temp_return;
  __temp_return:
  *__temp1226v=__temp35v__;
}

static inline __attribute__((always_inline)) void is_different__temp92v(uint64_t x, uint64_t y, int* __temp1227v) {
  int __temp93v=0;
  int __temp94v__=0;
  not__temp34v(__temp93v,&__temp94v__);
  goto __temp_return;
  __temp_return:
  *__temp1227v=__temp94v__;
}

static inline __attribute__((always_inline)) void add__temp169v(uint64_t x, uint64_t y, uint64_t* __temp1228v) {
  int __temp170v__=0;
  uint64_t z=0;
...
static inline __attribute__((always_inline)) void main__temp1219v() {
  ...
  __temp1222v=2;
  x=__temp1222v;
  add__temp169v(x,x,&__temp1223v__);
  print__temp375v(__temp1223v__);
}
