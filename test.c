...
const char* const __temp1311v="ls";
const char* const __temp345v="\n";

static inline __attribute__((always_inline)) void char__temp_buffer__buffer__temp488v(void** __temp1316v, unsigned long long* __temp1317v, unsigned long long* __temp1318v) {
  void* unsafe_ptr=0;
...
static inline __attribute__((always_inline)) void false__temp7v(int* __temp1319v) {
  int value=0;
  *__temp1319v=value;
}

static inline __attribute__((always_inline)) void not__temp26v(int __temp_anon0, int* __temp1320v) {
  int __temp27v__=0;
  false__temp7v(&__temp27v__);
  *__temp1320v=__temp27v__;
}

static inline __attribute__((always_inline)) void is_different__temp84v(unsigned long long x, unsigned long long y, int* __temp1321v) {
  int __temp85v=0;
  int __temp86v__=0;
  not__temp26v(__temp85v,&__temp86v__);
  *__temp1321v=__temp86v__;
}

static inline __attribute__((always_inline)) void neq__temp301v(unsigned long long x, unsigned long long y, int* __temp1322v) {
  int __temp302v__=0;
  int z=0;
...
static inline __attribute__((always_inline)) void free__temp422v(void** __temp1323v) {
  void* allocated=*__temp1323v;
  if(allocated)free(allocated);
  allocated=0;
  *__temp1323v=allocated;
}

static inline __attribute__((always_inline)) void eq__temp277v(unsigned long long x, unsigned long long y, int* __temp1324v) {
  int __temp278v__=0;
  int z=0;
...
static inline __attribute__((always_inline)) void mul__temp133v(unsigned long long x, unsigned long long y, unsigned long long* __temp1325v) {
  int __temp134v__=0;
...
static inline __attribute__((always_inline)) int alloc__temp419v(unsigned long long bytes, void** __temp1326v) {
  void* allocated=0;
  int failed=0;
  ...
  *__temp1326v=allocated;
  
  __temp_failure:
  return __temp_errcode;
}

static inline __attribute__((always_inline)) int alloc__temp433v(void** __temp1327v, unsigned long long* __temp1328v, unsigned long long* __temp1329v, unsigned long long size, void** __temp1330v, unsigned long long* __temp1331v, unsigned long long* __temp1332v) {
  void* buffer__unsafe_ptr=*__temp1327v;
  unsigned long long buffer__unsafe_size=*__temp1328v;
  unsigned long long buffer__unsafe_align=*__temp1329v;
...
static inline __attribute__((always_inline)) int alloc__temp487v(unsigned long long size, void** __temp1336v, unsigned long long* __temp1337v, unsigned long long* __temp1338v) {
  ...
  *__temp1336v=__temp491v__unsafe_ptr;
  *__temp1337v=__temp491v__unsafe_size;
  *__temp1338v=__temp491v__unsafe_align;
  
  __temp_failure:
  return __temp_errcode;
}

static inline __attribute__((always_inline)) void ge__temp253v(unsigned long long x, unsigned long long y, int* __temp1339v) {
  int __temp254v__=0;
  int z=0;
...
static inline __attribute__((always_inline)) void attach_type__temp12v(void* to, void* from, void** __temp1340v) {
  *__temp1340v=to;
}

static inline __attribute__((always_inline)) void add__temp424v(void* allocated, unsigned long long offset, void** __temp1341v) {
  void* element=0;
  void* __temp425v__=0;
  element=((char*)allocated)+offset;
  attach_type__temp12v(element,allocated,&__temp425v__);
  *__temp1341v=__temp425v__;
}

static inline __attribute__((always_inline)) int get__temp482v(void* buffer__unsafe_ptr, unsigned long long buffer__unsafe_size, unsigned long long buffer__unsafe_align, unsigned long long i, void** __temp1342v) {
  int __temp483v__=0;
  ...
  *__temp1342v=__temp485v__;
  
  __temp_failure:
  return __temp_errcode;
}

static inline __attribute__((always_inline)) void str__temp516v(void* buf__unsafe_ptr, unsigned long long buf__unsafe_size, unsigned long long buf__unsafe_align, unsigned long long dat__pos, unsigned long long dat__length, char dat__first, void** __temp1343v, unsigned long long* __temp1344v, unsigned long long* __temp1345v, unsigned long long* __temp1346v, unsigned long long* __temp1347v, char* __temp1348v) {
  *__temp1343v=buf__unsafe_ptr;
  *__temp1344v=buf__unsafe_size;
  *__temp1345v=buf__unsafe_align;
  *__temp1346v=dat__pos;
  *__temp1347v=dat__length;
  *__temp1348v=dat__first;
}

static inline __attribute__((always_inline)) int str__temp519v(void* buf__unsafe_ptr, unsigned long long buf__unsafe_size, unsigned long long buf__unsafe_align, unsigned long long pos, unsigned long long length, void** __temp1349v, unsigned long long* __temp1350v, unsigned long long* __temp1351v, unsigned long long* __temp1352v, unsigned long long* __temp1353v, char* __temp1354v) {
  ...
  *__temp1349v=__temp524v__buf__unsafe_ptr;
  *__temp1350v=__temp524v__buf__unsafe_size;
  *__temp1351v=__temp524v__buf__unsafe_align;
  *__temp1352v=__temp524v__dat__pos;
  *__temp1353v=__temp524v__dat__length;
  *__temp1354v=__temp524v__dat__first;
  
  __temp_failure:
  return __temp_errcode;
}

static inline __attribute__((always_inline)) int str__temp525v(const char* c, void** __temp1356v, unsigned long long* __temp1357v, unsigned long long* __temp1358v, unsigned long long* __temp1359v, unsigned long long* __temp1360v, char* __temp1361v) {
  ...
  *__temp1356v=__temp528v__buf__unsafe_ptr;
  *__temp1357v=__temp528v__buf__unsafe_size;
  *__temp1358v=__temp528v__buf__unsafe_align;
  *__temp1359v=__temp528v__dat__pos;
  *__temp1360v=__temp528v__dat__length;
  *__temp1361v=__temp528v__dat__first;
  
  __temp_failure:
  return __temp_errcode;
}

static inline __attribute__((always_inline)) void len__temp529v(void* s__buf__unsafe_ptr, unsigned long long s__buf__unsafe_size, unsigned long long s__buf__unsafe_align, unsigned long long s__dat__pos, unsigned long long s__dat__length, char s__dat__first, unsigned long long* __temp1362v) {
  *__temp1362v=s__dat__length;
}

static inline __attribute__((always_inline)) void add__temp109v(unsigned long long x, unsigned long long y, unsigned long long* __temp1363v) {
  int __temp110v__=0;
  unsigned long long z=0;
...
static inline __attribute__((always_inline)) void len__temp486v(void* buffer__unsafe_ptr, unsigned long long buffer__unsafe_size, unsigned long long buffer__unsafe_align, unsigned long long* __temp1364v) {
  *__temp1364v=buffer__unsafe_size;
}

static inline __attribute__((always_inline)) void gt__temp205v(unsigned long long x, unsigned long long y, int* __temp1365v) {
  int __temp206v__=0;
  int z=0;
...
static inline __attribute__((always_inline)) int copy__temp567v(void** __temp1366v, unsigned long long* __temp1367v, unsigned long long* __temp1368v, unsigned long long* __temp1369v, void* other__buf__unsafe_ptr, unsigned long long other__buf__unsafe_size, unsigned long long other__buf__unsafe_align, unsigned long long other__dat__pos, unsigned long long other__dat__length, char other__dat__first, void** __temp1370v, unsigned long long* __temp1371v, unsigned long long* __temp1372v, unsigned long long* __temp1373v, unsigned long long* __temp1374v, char* __temp1375v) {
  void* buf__unsafe_ptr=*__temp1366v;
  ...
  *__temp1369v=pos;
  *__temp1370v=__temp574v__buf__unsafe_ptr;
  *__temp1371v=__temp574v__buf__unsafe_size;
  *__temp1372v=__temp574v__buf__unsafe_align;
  *__temp1373v=__temp574v__dat__pos;
  *__temp1374v=__temp574v__dat__length;
  *__temp1375v=__temp574v__dat__first;
...
static inline __attribute__((always_inline)) void lt__temp181v(unsigned long long x, unsigned long long y, int* __temp1376v) {
  int __temp182v__=0;
  int z=0;
...
static inline __attribute__((always_inline)) void char__temp531v(const char* s, char* __temp1377v) {
  char c=0;
  c=s?s[0]:0;
  *__temp1377v=c;
}

static inline __attribute__((always_inline)) void eq__temp532v(char x, char y, int* __temp1378v) {
  int z=0;
  z=(x==y);
  *__temp1378v=z;
}

static inline __attribute__((always_inline)) int copy_null_terminated__temp544v(void* other__buf__unsafe_ptr, unsigned long long other__buf__unsafe_size, unsigned long long other__buf__unsafe_align, unsigned long long other__dat__pos, unsigned long long other__dat__length, char other__dat__first, void** __temp1382v, unsigned long long* __temp1383v, unsigned long long* __temp1384v, unsigned long long* __temp1385v, unsigned long long* __temp1386v, char* __temp1387v) {
  ...
  *__temp1382v=__temp551v__buf__unsafe_ptr;
  *__temp1383v=__temp551v__buf__unsafe_size;
  *__temp1384v=__temp551v__buf__unsafe_align;
  *__temp1385v=__temp551v__dat__pos;
  *__temp1386v=__temp551v__dat__length;
  *__temp1387v=__temp551v__dat__first;
  
  __temp_failure:
  return __temp_errcode;
}

int unsafe_temporary_cstr__temp552v(void* other__buf__unsafe_ptr, unsigned long long other__buf__unsafe_size, unsigned long long other__buf__unsafe_align, unsigned long long other__dat__pos, unsigned long long other__dat__length, char other__dat__first, const char** __temp1392v) {
  ...
  const char* ret=0;
  unsigned long long __temp1390v=0;
  int __temp1391v=0;
  int __temp_errcode=0;
  ...
  *__temp1392v=ret;
  ...
  __temp_failure:__temp1390v=0;
  neq__temp301v(__temp564v__buf__unsafe_size,__temp1390v,&__temp1391v);
  if(__temp1391v){
...
static inline __attribute__((always_inline)) void int__temp375v(unsigned long long x, long long int* __temp1393v) {
  long long int z=0;
  z=x;
  *__temp1393v=z;
}

static inline __attribute__((always_inline)) void is_different__temp72v(long long int x, long long int y, int* __temp1394v) {
  int __temp73v=0;
  int __temp74v__=0;
  not__temp26v(__temp73v,&__temp74v__);
  *__temp1394v=__temp74v__;
}

static inline __attribute__((always_inline)) void neq__temp290v(long long int x, long long int y, int* __temp1395v) {
  int __temp291v__=0;
  int z=0;
...
static inline __attribute__((always_inline)) int system__temp988v(void* _cmd__buf__unsafe_ptr, unsigned long long _cmd__buf__unsafe_size, unsigned long long _cmd__buf__unsafe_align, unsigned long long _cmd__dat__pos, unsigned long long _cmd__dat__length, char _cmd__dat__first) {
  const char* __temp989v__=0;
  const char* cmd=0;
  long long int result=0;
  unsigned long long __temp990v=0;
  long long int __temp991v__=0;
  int __temp992v__=0;
  int __temp_errcode=0;
  __temp_errcode=unsafe_temporary_cstr__temp552v(_cmd__buf__unsafe_ptr,_cmd__buf__unsafe_size,_cmd__buf__unsafe_align,_cmd__dat__pos,_cmd__dat__length,_cmd__dat__first,&__temp989v__);
  if(__temp_errcode){
  goto __temp_failure;
  }
  cmd=__temp989v__;
  ...
  __temp990v=0;
  int__temp375v(__temp990v,&__temp991v__);
  neq__temp290v(result,__temp991v__,&__temp992v__);
  if(__temp992v__){
  __temp_errcode=25;
  goto __temp_failure;
  }
...
static inline __attribute__((always_inline)) int main__temp1306v() {
  unsigned long long __temp1307v=0;
  void* __temp1308v__unsafe_ptr=0;
  unsigned long long __temp1308v__unsafe_size=0;
  unsigned long long __temp1308v__unsafe_align=0;
  void* buf__unsafe_ptr=0;
  unsigned long long buf__unsafe_size=0;
  unsigned long long buf__unsafe_align=0;
  unsigned long long __temp1310v=0;
  void* __temp1312v__buf__unsafe_ptr=0;
  unsigned long long __temp1312v__buf__unsafe_size=0;
  unsigned long long __temp1312v__buf__unsafe_align=0;
  unsigned long long __temp1312v__dat__pos=0;
  unsigned long long __temp1312v__dat__length=0;
  char __temp1312v__dat__first=0;
  void* __temp1313v__buf__unsafe_ptr=0;
  unsigned long long __temp1313v__buf__unsafe_size=0;
  unsigned long long __temp1313v__buf__unsafe_align=0;
  unsigned long long __temp1313v__dat__pos=0;
  unsigned long long __temp1313v__dat__length=0;
  char __temp1313v__dat__first=0;
  ...
  unsigned long long __temp1397v=0;
  int __temp1398v=0;
  int __temp_errcode=0;
  __temp1307v=2;
  __temp_errcode=alloc__temp487v(__temp1307v,&__temp1308v__unsafe_ptr,&__temp1308v__unsafe_size,&__temp1308v__unsafe_align);
  if(__temp_errcode){
  goto __temp_failure;
  }
  buf__unsafe_ptr=__temp1308v__unsafe_ptr;
  buf__unsafe_size=__temp1308v__unsafe_size;
  buf__unsafe_align=__temp1308v__unsafe_align;
  __temp1310v=0;
  __temp_errcode=str__temp525v(__temp1311v,&__temp1312v__buf__unsafe_ptr,&__temp1312v__buf__unsafe_size,&__temp1312v__buf__unsafe_align,&__temp1312v__dat__pos,&__temp1312v__dat__length,&__temp1312v__dat__first);
  if(__temp_errcode){
  goto __temp_failure;
  }
  __temp_errcode=copy__temp567v(&buf__unsafe_ptr,&buf__unsafe_size,&buf__unsafe_align,&__temp1310v,__temp1312v__buf__unsafe_ptr,__temp1312v__buf__unsafe_size,__temp1312v__buf__unsafe_align,__temp1312v__dat__pos,__temp1312v__dat__length,__temp1312v__dat__first,&__temp1313v__buf__unsafe_ptr,&__temp1313v__buf__unsafe_size,&__temp1313v__buf__unsafe_align,&__temp1313v__dat__pos,&__temp1313v__dat__length,&__temp1313v__dat__first);
  if(__temp_errcode){
  goto __temp_failure;
  }
  s__buf__unsafe_ptr=__temp1313v__buf__unsafe_ptr;
  s__buf__unsafe_size=__temp1313v__buf__unsafe_size;
  s__buf__unsafe_align=__temp1313v__buf__unsafe_align;
  s__dat__pos=__temp1313v__dat__pos;
  s__dat__length=__temp1313v__dat__length;
  s__dat__first=__temp1313v__dat__first;
  ...
  __temp_errcode=system__temp988v(s__buf__unsafe_ptr,s__buf__unsafe_size,s__buf__unsafe_align,s__dat__pos,s__dat__length,s__dat__first);
  if(__temp_errcode){
  goto __temp_failure;
  }
  
  __temp_failure:__temp1397v=0;
  neq__temp301v(__temp1308v__unsafe_size,__temp1397v,&__temp1398v);
  if(__temp1398v){
  __temp1308v__unsafe_size=0;
  free__temp422v(&__temp1308v__unsafe_ptr);
  }
  
  return __temp_errcode;
}

int main() {main__temp1306v();return 0;}