...
static inline __attribute__((always_inline)) void is_different__temp69v(uint64_t x, uint64_t y, int* __temp1282v) {
  int __temp70v=0;
  int __temp71v__=0;
  not__temp35v(__temp70v,&__temp71v__);
  goto __temp_return;
  __temp_return:
  *__temp1282v=__temp71v__;
}

static inline __attribute__((always_inline)) void eq__temp96v(uint64_t x, uint64_t y, char* __temp1283v) {
  int __temp97v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void neq__temp120v(uint64_t x, uint64_t y, char* __temp1284v) {
  int __temp121v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void mul__temp172v(uint64_t x, uint64_t y, uint64_t* __temp1285v) {
  int __temp173v__=0;
  uint64_t z=0;
...
static inline __attribute__((always_inline)) void ge__temp297v(uint64_t x, uint64_t y, char* __temp1307v) {
  int __temp298v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void add__temp148v(uint64_t x, uint64_t y, uint64_t* __temp1315v) {
  int __temp149v__=0;
  uint64_t z=0;
...
static inline __attribute__((always_inline)) void gt__temp249v(uint64_t x, uint64_t y, char* __temp1335v) {
  int __temp250v__=0;
  char z=0;
...
static inline __attribute__((always_inline)) void print__temp1224v(char* p__name__unsafe_ptr, uint64_t p__name__dat__pos, uint64_t p__name__dat__length, char p__name__dat__first, char* p__surname__unsafe_ptr, uint64_t p__surname__dat__pos, uint64_t p__surname__dat__length, char p__surname__dat__first) {
  print__temp361v(__temp1225v);
  print__temp364v(__temp1227v,__temp797v);
  print__temp716v(p__name__unsafe_ptr,p__name__dat__pos,p__name__dat__length,p__name__dat__first);
  print__temp364v(__temp1230v,__temp797v);
  print__temp716v(p__surname__unsafe_ptr,p__surname__dat__pos,p__surname__dat__length,p__surname__dat__first);
  print__temp361v(__temp1225v);
}
...
static inline __attribute__((always_inline)) int main__temp1267v() {
  ...
  print__temp716v(__temp1273v__unsafe_ptr,__temp1273v__dat__pos,__temp1273v__dat__length,__temp1273v__dat__first);
