...
static inline int alloc__temp382v(unsigned long long bytes__value, void** __temp464v) {
  void* allocated=0;
  int failed=0;
...
static inline int alloc__temp391v(void** __temp465v, unsigned long long* __temp466v, unsigned long long* __temp467v, unsigned long long size__value, void** __temp468v, unsigned long long* __temp469v, unsigned long long* __temp470v) {
  ...
  if(__temp392v__z){
  __temp393v=0;
  mul__temp132v(buffer__unsafe_align,size__value,&__temp394v__z);
  ...
  mul__temp132v(buffer__unsafe_align,size__value,&__temp398v__z);
  bytes=__temp398v__z;
...
static inline int mutget__temp420v(void** __temp474v, unsigned long long* __temp475v, unsigned long long* __temp476v, unsigned long long i__value, void** __temp477v) {
  ...
  mul__temp132v(i__value,buffer__unsafe_align,&__temp422v__z);
...
static inline int realloc__temp383v(void* allocated, unsigned long long bytes__value, void** __temp481v) {
...
static inline int resize__temp402v(void** __temp483v, unsigned long long* __temp484v, unsigned long long* __temp485v, unsigned long long size__value, void** __temp486v, unsigned long long* __temp487v, unsigned long long* __temp488v) {
  ...
  buffer__unsafe_size=size__value;
  mul__temp132v(buffer__unsafe_align,size__value,&__temp409v__z);
  bytes=__temp409v__z;
...
static inline int get__temp424v(void* buffer__unsafe_ptr, unsigned long long buffer__unsafe_size, unsigned long long buffer__unsafe_align, unsigned long long i__value, void** __temp497v) {
  int __temp425v__z=0;
  ...
  mul__temp132v(i__value,buffer__unsafe_align,&__temp426v__z);
...
static inline int main__temp444v() {
  ...
  memcpy(&__temp449v__z,(char*)__temp448v____temp427v____temp388v__to,8);
  __temp450v=1;
  ...
  memcpy(&__temp452v__z,(char*)__temp451v____temp427v____temp388v__to,8);
  add__temp86v(__temp449v__z,__temp452v__z,&__temp453v__z);
  print__temp335v(__temp453v__z);
  return 0;
  __temp_failure:
  return __temp_errcode;
}
