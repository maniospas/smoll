...
<div class="smoll-features">
  ...
  <div class="smoll-feature"><h3>Duck and algebraic types</h3><p>Functions define types. Interact with those with zero runtime overhead.</p></div>
  <div class="smoll-feature"><h3>Supported</h3><p>Compiler, LSP, many backends (for executables, WASM, and a VM), web import, playground.</p></div>
