...
static inline __attribute__((always_inline)) void float____buffer__t1560t(char** __t1573t, uint64_t* __t1574t, uint16_t* __t1575t, uint16_t* __t1576t) {
  char* unsafe_ptr=0;
...
static inline __attribute__((always_inline)) void add__t175t(uint64_t x, uint64_t y, uint64_t* __t1597t) {
  int __t176t__=0;
  uint64_t z=0;
...
static inline __attribute__((always_inline)) void attach_type__t22t(char* to, char* from, char** __t1598t) {
  *__t1598t=to;
}

static inline __attribute__((always_inline)) void add__t505t(char* allocated, uint64_t offset, char** __t1599t) {
  char* element=0;
  char* __t506t__=0;
...
static inline __attribute__((always_inline)) int mutget__t633t(char** __t1600t, uint64_t* __t1601t, uint16_t* __t1602t, uint16_t* __t1603t, uint64_t i, char** __t1604t) {
...
static inline __attribute__((always_inline)) int main__t1555t() {
  ...
  char __t1565t____t534t__=0;
  uint64_t __t1566t=0;
  char* __t1567t__=0;
  char* element=0;
  double __t1568t____0=0;
  double __t1570t=0;
  ...
  console__t366t();
  __t1557t=1.0;
  float____buffer__t1560t(&__t1562t__unsafe_ptr,&__t1562t__unsafe_size,&__t1562t__unsafe_offset,&__t1562t__unsafe_align);
  __t1563t=1;
  __t_errcode=alloc__t532t(&__t1562t__unsafe_ptr,&__t1562t__unsafe_size,&__t1562t__unsafe_offset,&__t1562t__unsafe_align,__t1563t,&__t1564t__unsafe_ptr,&__t1564t__unsafe_size,&__t1564t__unsafe_offset,&__t1564t__unsafe_align);
  if(__t_errcode){
  goto __t_failure;
  }
  memcpy(__t1562t__unsafe_ptr,&__t1557t,8);
  __t1566t=0;
  __t_errcode=mutget__t633t(&__t1562t__unsafe_ptr,&__t1562t__unsafe_size,&__t1562t__unsafe_offset,&__t1562t__unsafe_align,__t1566t,&__t1567t__);
  if(__t_errcode){
  goto __t_failure;
  }
  element=__t1567t__;
  ...
  memcpy(&__t1568t____0,element,8);
  print__t385t(__t1568t____0);
  __t1570t=2.0;
  if(!element){
  __t_errcode=2;
  goto __t_failure;
  }
  memcpy(element,&__t1570t,8);
  if(!element){
  __t_errcode=2;
  goto __t_failure;
  }
  ...
  __t_skip_returns:exists__t447t(__t1564t__unsafe_ptr,&__t1565t____t534t__);
  if(__t1565t____t534t__){
  free__t503t(&__t1564t__unsafe_ptr);
  }
